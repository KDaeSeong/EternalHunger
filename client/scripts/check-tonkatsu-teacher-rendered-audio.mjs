...
assert.match(rendererSource, /theme: 'tonkatsu-kitchen'[\s\S]*lead: 'vibraphone'[\s\S]*counter: 'bell'[\s\S]*woodwind: 'bassoon'/, '주방 장면에는 말렛·벨·바순 편성이 필요합니다.');
assert.match(rendererSource, /theme: 'tonkatsu-contest'[\s\S]*lead: 'trumpet'/, '대회 장면에 트럼펫이 필요합니다.');
assert.match(rendererSource, /theme: 'tonkatsu-judge'[\s\S]*lead: 'oboe'[\s\S]*counter: 'celesta'/, '심사 장면에는 오보에와 첼레스타가 필요합니다.');
