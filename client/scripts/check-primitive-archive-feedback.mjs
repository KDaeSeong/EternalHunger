...
const base = {
  ...
  log: ['Day 1: 기존 기록'],
  party: [{ hp: 100 }],
  counters: { gather: 0, hunt: 0, craft: 0, logging: 0, herbal: 0, trap: 0, farm: 0, herd: 0, fish: 0, mine: 0, quarry: 0, survey: 0, patrol: 0, treatment: 0, festival: 0, season_plan: 0, drill: 0, debate: 0, irrigation: 0, kiln: 0, weave: 0, smelt: 0, forge: 0, mill: 0, market: 0, preserve: 0, road: 0, trade_route: 0, settlement: 0, voyage: 0, meals: 0, camp: 0 },
...
const actionRows = [
  ...
  { label: '벌목', action: 'primitive-logging', cue: 'logging', resultLabel: '벌목 성공', log: 'Day 1: 벌목 성공', counter: 'logging' },
  { label: '약초 채집', action: 'primitive-herbalism', cue: 'herbal', resultLabel: '약초 채집 성공', log: 'Day 1: 약초 채집 성공', counter: 'herbal' },
  { label: '덫 사냥', action: 'primitive-trapping', cue: 'trap', resultLabel: '덫 사냥 성공', log: 'Day 1: 덫 사냥 성공', counter: 'trap' },
  ...
  { label: '계절 대비', action: 'primitive-season-plan', cue: 'archiveSeasonPlan', resultLabel: '계절 대비 완료', log: 'Day 1: 계절 대비 완료. 다음 야영 3회의 추위 피해를 줄입니다.', counter: 'season_plan' },
  { label: '훈련 태세', action: 'primitive-drill', cue: 'archiveDrill', resultLabel: '훈련 태세 준비', log: 'Day 1: 훈련 태세 완료. 다음 사냥 계열 3회에 보정을 적용합니다.', counter: 'drill' },
  { label: '학술 토론', action: 'primitive-debate', cue: 'archiveDebate', resultLabel: '학술 토론 완료', log: 'Day 1: 학술 토론 완료. 수렵 +5RP · 정착 +3CP.', counter: 'debate' },
  { label: '관개 정비', action: 'primitive-irrigation', cue: 'archiveIrrigation', resultLabel: '관개 정비 완료', log: 'Day 1: 관개 정비 완료. 다음 농업 3회에 관개 효과를 적용합니다.', counter: 'irrigation' },
  { label: '가마 굽기', action: 'primitive-kiln', cue: 'archiveKiln', resultLabel: '가마 굽기 완료', log: 'Day 1: 가마 굽기 완료. 점토를 가공해 토기 2을 생산했습니다.', counter: 'kiln' },
  { label: '방직', action: 'primitive-weave', cue: 'archiveWeave', resultLabel: '방직 완료', log: 'Day 1: 방직 완료. 섬유를 가공해 직물 1을 생산했습니다.', counter: 'weave' },
  { label: '제련', action: 'primitive-smelt', cue: 'archiveSmelt', resultLabel: '제련 완료', log: 'Day 1: 제련 완료. 금속광을 가공해 금속 주괴 1을 생산했습니다.', counter: 'smelt' },
  { label: '단조', action: 'primitive-forge', cue: 'archiveForge', resultLabel: '단조 완료', log: 'Day 1: 단조 완료. 금속 주괴를 가공해 금속 공구 1을 생산했습니다.', counter: 'forge' },
  { label: '제분', action: 'primitive-mill', cue: 'archiveMill', resultLabel: '제분 완료', log: 'Day 1: 제분 완료. 곡물을 가공해 제분 곡물 2을 생산했습니다.', counter: 'mill' },
  { label: '시장 거래', action: 'primitive-market', cue: 'archiveMarket', resultLabel: '시장 거래 완료', log: 'Day 1: 시장 거래 완료. 토기 2을 내주고 약초 3을 확보했습니다.', counter: 'market' },
  { label: '식량 보존', action: 'primitive-preserve', cue: 'archivePreserve', resultLabel: '식량 보존 완료', log: 'Day 1: 식량 보존 완료. 보존 식량 꾸러미 1개를 만들었습니다.', counter: 'preserve' },
  { label: '도로 정비', action: 'primitive-road', cue: 'archiveRoad', resultLabel: '도로 정비 완료', log: 'Day 1: 도로 정비 완료. 다음 현장 행동 4회의 스태미나 소모를 줄입니다.', counter: 'road' },
  { label: '교역로 개설', action: 'primitive-trade-route', cue: 'archiveTradeRoute', resultLabel: '교역로 개설 완료', log: 'Day 1: 교역로 개설 완료. 다음 성공 교역 3회에 교역로 효과를 적용합니다.', counter: 'trade_route' },
  { label: '정착지 확장', action: 'primitive-settlement', cue: 'archiveSettlement', resultLabel: '정착지 확장 완료', log: 'Day 1: 정착지 확장 완료. 부족 수용력 +2.', counter: 'settlement' },
  { label: '항해 답사', action: 'primitive-voyage', cue: 'archiveVoyage', resultLabel: '항해 답사 완료', log: 'Day 1: 항해 답사 완료. 새 지역을 발견했습니다.', counter: 'voyage' },
...
for (const cue of [
  ...
  'archiveSurvey', 'archivePatrol', 'archiveTreat', 'archiveFestival', 'archiveSeasonPlan', 'archiveDrill', 'archiveDebate', 'archiveIrrigation', 'archiveKiln', 'archiveWeave', 'archiveSmelt', 'archiveForge', 'archiveMill', 'archiveMarket', 'archivePreserve', 'archiveRoad', 'archiveTradeRoute', 'archiveSettlement', 'archiveVoyage', 'archiveTune', 'archiveSwitch', 'consume', 'rest', 'research', 'policy', 'camp',
...
for (const icon of [
  ...
  'primitive-survey', 'primitive-patrol', 'primitive-treatment', 'primitive-festival', 'primitive-season-plan', 'primitive-drill', 'primitive-debate', 'primitive-irrigation', 'primitive-kiln', 'primitive-weave', 'primitive-smelt', 'primitive-forge', 'primitive-mill', 'primitive-market', 'primitive-preserve', 'primitive-road', 'primitive-trade-route', 'primitive-settlement', 'primitive-voyage',
