...
const base = {
  ...
  log: ['Day 1: 기존 기록'],
  party: [{ hp: 100 }],
  counters: { gather: 0, hunt: 0, craft: 0, logging: 0, herbal: 0, trap: 0, farm: 0, herd: 0, fish: 0, mine: 0, quarry: 0, survey: 0, patrol: 0, treatment: 0, festival: 0, irrigation: 0, preserve: 0, road: 0, meals: 0, camp: 0 },
...
for (const cue of [
  ...
  'archiveSurvey', 'archivePatrol', 'archiveTreat', 'archiveFestival', 'archiveIrrigation', 'archivePreserve', 'archiveRoad', 'consume', 'rest', 'research', 'policy', 'camp',
...
for (const icon of [
  ...
  'primitive-survey', 'primitive-patrol', 'primitive-treatment', 'primitive-festival', 'primitive-irrigation', 'primitive-preserve', 'primitive-road',
