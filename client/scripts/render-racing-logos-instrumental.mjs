...
export const RACING_LOGOS_RENDER_TRACKS = Object.freeze([
  {
    ...
    lead: 'guitar', counter: 'piano', pad: 'strings', highStrings: 'violin', midStrings: 'viola',
  ...
  },
  {
    ...
    lead: 'celesta', counter: 'piano', pad: 'strings', highStrings: 'violin', midStrings: 'viola',
  ...
  },
  {
    ...
    lead: 'trumpet', counter: 'guitar', pad: 'choir', highStrings: 'violin', midStrings: 'viola',
  ...
  },
  {
    ...
    lead: 'guitar', counter: 'violin', pad: 'strings', highStrings: 'violin', midStrings: 'viola',
