...
export const TONKATSU_TEACHER_RENDER_TRACKS = Object.freeze([
  ...
  },
  {
    ...
    lead: 'vibraphone', counter: 'bell', pad: 'strings', highStrings: 'violin', midStrings: 'viola',
  ...
  },
  {
    ...
    lead: 'oboe', counter: 'celesta', pad: 'strings', highStrings: 'violin', midStrings: 'viola',
    lowStrings: 'cello', woodwind: 'bassoon', brassSection: 'horn', lowBrass: 'trombone', harp: 'harp',
  ...
  },
  {
    ...
    lead: 'cello', counter: 'harp', pad: 'strings', highStrings: 'violin', midStrings: 'viola',
    lowStrings: 'cello', woodwind: 'bassoon', brassSection: 'horn', lowBrass: 'trombone', harp: 'harp',
