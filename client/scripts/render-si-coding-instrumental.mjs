...
export const SI_CODING_RENDER_TRACKS = Object.freeze([
  {
    ...
    lead: 'piano', counter: 'celesta', pad: 'strings', highStrings: 'violin', midStrings: 'viola',
  ...
  },
  {
    ...
    lead: 'clarinet', counter: 'harp', pad: 'choir', highStrings: 'violin', midStrings: 'viola',
  ...
  },
  {
    ...
    lead: 'oboe', counter: 'piano', pad: 'strings', highStrings: 'violin', midStrings: 'viola',
    lowStrings: 'cello', woodwind: 'clarinet', brassSection: 'horn', lowBrass: 'trombone', harp: 'harp',
    percussion: 'orchestral', drumScale: 0.6, room: 0.27,
  },
  {
    theme: 'coding-risk', file: 'risk', title: '장애 대응', bars: 44,
    lead: 'horn', counter: 'cello', pad: 'choir', highStrings: 'violin', midStrings: 'viola',
  ...
  },
  {
    ...
    lead: 'violin', counter: 'bell', pad: 'choir', highStrings: 'violin', midStrings: 'viola',
    lowStrings: 'cello', woodwind: 'flute', brassSection: 'horn', lowBrass: 'trombone', harp: 'harp',
