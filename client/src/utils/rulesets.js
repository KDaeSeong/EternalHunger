...
const DEFAULT_MARKET_RULES = {
  ...
  drone: {
    ...
    chanceNeedLowInv: 0.48,
    chanceNeedDefault: 0.30,
    chanceLowInv: 0.22,
    chanceInv2: 0.14,
    chanceDefault: 0.06,
    chanceRoutePlanNeed: 0.58,
    surplusMinCredits: 180,
    // 목표 재료 가중치
    needWeightMul: 12,
    needFallbackWeight: 6,
    needFallbackPrice: 10,
    routeNeedWeightBonus: 8,
    routeNeedFallbackWeight: 10,
    fallbackKeywords: [
      '천', '가죽', '철', '돌', '나뭇',
...
export const RULESETS = {
  ER_S11: {
    ...
    ai: {
      ...
      erPresetStatScale: 1,
      earlyRouteFarmAttempts: 6,
      earlyRouteMaxSearches: 5,
