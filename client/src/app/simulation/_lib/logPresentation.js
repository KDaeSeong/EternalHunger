...
const LOW_SIGNAL_TEXT_RE = /목표\(|이동:|교전 회피|인터럽트 도주|회복 우선 이동|획득 실패|가방 가득|x0|크레딧 \+|보상 크레딧|폭발 타이머 (?:15|10|5)s|재생: HP|종료$|면역$|저항$|보호막: 피해|드론 호출:|음식 상자|주변을|발자국|숨을 고르며|머무릅니다/i;
