...
export const STUDENTS = [
  {
    ...
    range: 1,
    move: 2,
    skillIds: ['sk_guard', 'sk_bleed_round'],
    tacticalProfile: '선봉에서 보호막으로 버티고 출혈탄으로 첫 대상을 묶습니다.',
  },
  {
    id: 's_yuuka',
    name: '유우카',
    ...
    range: 1,
    move: 2,
    skillIds: ['sk_guard', 'sk_first_aid'],
    tacticalProfile: '방어 태세와 응급 처치로 별 조건의 전원 생존을 보조합니다.',
  },
  {
    id: 's_mika',
    name: '미카',
    ...
    range: 1,
    move: 3,
    skillIds: ['sk_dash_strike', 'sk_bleed_round'],
    tacticalProfile: '근거리 고화력으로 보스와 장갑병을 빠르게 정리합니다.',
  },
  {
    id: 's_noa',
    name: '노아',
    ...
    range: 3,
    move: 2,
    skillIds: ['sk_confuse_shot', 'sk_first_aid'],
    tacticalProfile: '교란 사격으로 적 명중률을 낮추고 빈 턴에는 회복을 담당합니다.',
  },
  {
    id: 's_hina',
    name: '히나',
    ...
    range: 4,
    move: 2,
    skillIds: ['sk_burn_round', 'sk_precise_shot'],
    tacticalProfile: '원거리 화력과 화상으로 고방어 적의 체력을 꾸준히 깎습니다.',
  },
  {
    id: 's_shiroko',
    name: '시로코',
    ...
    range: 3,
    move: 3,
    skillIds: ['sk_precise_shot', 'sk_confuse_shot'],
    tacticalProfile: '기동 사격으로 후열을 압박하고 교란으로 반격 기대값을 낮춥니다.',
  },
  {
    id: 's_serika',
    name: '세리카',
    ...
    range: 3,
    move: 3,
    skillIds: ['sk_first_aid', 'sk_bleed_round'],
    tacticalProfile: '가벼운 회복과 출혈 압박을 오가며 장기전을 안정화합니다.',
  },
  {
    id: 's_iori',
    name: '이오리',
    ...
    range: 5,
    move: 2,
    skillIds: ['sk_precise_shot', 'sk_grenade_flash'],
    tacticalProfile: '긴 사거리와 섬광으로 저격수/포대형 적을 먼저 끊습니다.',
  },
];
...
export const TACTICAL_SKILLS = [
  ...
  },
  {
    ...
    damageMul: 1.35,
    accuracyAdd: 0.04,
    desc: '근거리 대상에게 강한 피해를 줍니다. 장갑병이나 보스에게 화력을 집중할 때 좋습니다.',
  },
  {
    id: 'sk_bleed_round',
    name: '출혈탄',
