...
export const GAME_ROADMAP = [
  ...
  },
  {
    ...
    subtitle: 'Coding Sim',
    priority: '이식 진행',
    scope: '과제팩, 다중 파일 수정, 문서 체크포인트, 실행/정적 판정, 힌트/자원, 회사 지원, 커리어 성장, 후속 현장, 저장/전적, 기능별 빠른 탭 UI',
    summary: '업로드된 Step 과제팩을 기반으로 문서 확인, 코드 수정, 보고서 작성, 문자열 기반 검수, 힌트 비용, 프로젝트 종료 판정, 회사 지원과 커리어 성장이 연결된 challenge sim playable slice입니다.',
    nextStep: '남은 작업은 브라우저 샌드박스 실제 실행, 문제팩 난이도 검수, 커뮤니티 챌린지/랭킹용 제출 비교 UI를 강화하는 것입니다.',
  },
  {
    slug: 'rail3d-sim',
    title: 'Rail 3D Sim',
