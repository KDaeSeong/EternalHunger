...
export const GAME_ROADMAP = [
  {
    ...
    priority: '1차 이식',
    scope: '카드 DB, 덱 빌더, 듀얼 샌드박스, 방 저장, 전적, 자동 플레이 보조, 턴 어드바이저, 매치 리포트, 리플레이 타임라인, 체인 감사, JSON 리플레이 내보내기, 기능별 탭 UI',
    summary: '턴, 페이즈, 소환, 세트, 전투, 체인, 덱 저장, 게임방 상태 저장, 전적 기록, 보드/턴 판단/패/로그 탭, 매치 리포트, 턴별 리플레이 타임라인, 감사 결과가 포함된 JSON 리플레이 내보내기까지 붙은 카드 배틀 playable slice입니다.',
    nextStep: '원본 v13 카드 효과를 더 넓게 이식하고, 게임방 멀티 동시성 충돌 검증을 강화합니다.',
  },
  {
    slug: 'ba-vanguard',
    title: 'BA Vanguard',
    ...
    priority: '1차 후보',
    scope: '카드 라이브러리, 덱 검사, 플레이테스트, 라이브 전술 리포트, 리플레이 흐름 분석, 매치업 자동 실험, JSON 리플레이 내보내기, 저장/전적, 게임방 상태 저장, 기능별 탭 UI',
    summary: '덱 구성 규칙, 라이드/콜/스트라이드/배틀 샌드박스, 간단 AI 진행, 전술 리포트, 가드 감사가 포함된 리플레이 흐름 분석, 매치업 자동 실험 리포트, 감사 결과가 포함된 JSON 리플레이 내보내기, 게임방 상태 저장이 붙은 카드 배틀 playable slice입니다.',
    nextStep: '카드 효과 범위와 방 동시 편집 충돌 검증을 강화합니다.',
  },
  {
  ...
  },
  {
    ...
    subtitle: 'Idle RPG',
    priority: '장기 성장형',
    scope: '방치 정산, 장비, 타워, 미션, 강화, 분해, 상점, 일일 운영 플랜, 성장 리포트, 성장 로드맵, 시즌/장기 밸런스 리포트, 시즌 보상 테이블/수령, 계정 동기화 리포트, 저장/전적, 기능별 탭 UI',
    summary: '방치 정산과 반복 성장, 장비 프리셋, 자동 분해, 탑 상점, 일일 운영 플랜, 오늘/주간/장기 로드맵, 시즌 트랙/장기 밸런스 점검, 시즌 보상, 계정 동기화 payload 리포트까지 연결된 장기 성장형 playable slice입니다.',
    nextStep: '완성 이후에는 실제 서버 계정 병합 정책과 추가 콘텐츠팩 시즌 같은 선택형 확장만 남았습니다.',
  },
  {
    slug: 'ba-srpg',
    title: 'BA SRPG',
  ...
  },
  {
    ...
    priority: '이식 진행',
    scope: '거래, 재고, 매출채권, VAT, 월말 결산, 글로벌 수출입, 자본시장, 원장 스냅샷/복원, 리포트 북마크/내보내기, 장기 리포트 추세, JSON/CSV 다운로드, 복원 로그 비교, 저장/전적, 기능별 빠른 탭 UI',
    summary: '주문 생성, 생산 입고, 출고와 채권 회수, VAT 납부, 월말 결산, 수출입/환헤지, 상장 공시와 자금조달, 원장 스냅샷 diff/복원, 장기 리포트 추세, 진행 보고서 JSON/CSV 다운로드와 테이블별 복원 비교까지 연결된 business ledger playable slice입니다.',
    nextStep: '완성 이후에는 원본 Spring API 스타일의 상세 보고서 뷰와 서버 리포트 아카이브 동기화 같은 선택형 확장만 남았습니다.',
  },
  {
    ...
    subtitle: 'Asset Lab',
    priority: '이식 진행',
    scope: 'core 트랙/이벤트, 로컬팩 JSON, 로고 fallback, 검수 매트릭스, 감사 기록, 시즌 캘린더, 시즌 카드 생성, 이벤트 카드 생성, 상세 제작 탭, 저장/전적, 기능별 빠른 탭 UI',
    summary: '공개 가능한 트랙/이벤트 데이터와 개인용 local pack 우선 로고 규칙, placeholder fallback, 감사 점수, 시즌 캘린더 리포트, 시즌/이벤트 카드 생성, 로컬팩 매트릭스를 다루는 asset lab playable slice입니다.',
    nextStep: '남은 작업은 실존 로고팩 배포 방식과 장기 레이스 결과 모델을 별도 데이터 팩으로 분리하는 확장입니다.',
  },
];
