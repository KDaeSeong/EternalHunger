...
export const GAME_ROADMAP = [
  ...
  },
  {
    ...
    priority: '2차 후보',
    scope: '주방, 영업, 배식, 전투, 시설, 연구, 대회, 심사위원, 운영 리포트, 저장/전적, 기능별 빠른 탭 UI, 상세 관리 탭',
    summary: '재료 매입, 메뉴 제작, 영업 판매, 학생 배식/전투, 시설/연구 성장, 대회와 심사위원 모드를 기능별 탭과 상세 관리 탭 안에서 다루는 경영형 playable slice입니다.',
    nextStep: '남은 작업은 밸런스 튜닝, 초반 튜토리얼, 영업/전투 연출을 다듬는 폴리싱입니다.',
  },
  {
  ...
  },
  {
    ...
    subtitle: 'School Sim',
    priority: '분리 후보',
    scope: '주간 운영, 장기 비전, 정책, 사건 대응, 학생/진로, 교사/시설, 동아리/행사, 학기 리포트, 저장/전적, 기능별 빠른 탭 UI, 상세 운영 탭',
    summary: '주간 AP 운영과 사건 대응, 학생/교사/시설 관리, 진로 상담, 동아리/축제, 학기 리포트와 장기 비전 평가를 기능별 탭과 상세 운영 탭 안에서 다루는 학교 경영 playable slice입니다.',
    nextStep: '남은 작업은 학년별 이벤트 다양화, 초반 튜토리얼, 학기별 밸런스 튜닝을 보강하는 것입니다.',
  },
  {
    slug: 'si-coding-sim',
    title: 'SI 코딩 시뮬레이터',
    subtitle: 'Coding Sim',
    priority: '이식 진행',
    scope: '과제팩, 다중 파일 수정, 문서 체크포인트, 실행/정적 판정, 힌트/자원, 회사 지원, 커리어 성장, 후속 현장, 저장/전적, 기능별 빠른 탭 UI, 상세 현장 탭',
    summary: '업로드된 Step 과제팩을 기반으로 문서 확인, 코드 수정, 보고서 작성, 문자열 기반 검수, 힌트 비용, 프로젝트 종료 판정, 회사 지원, 커리어 성장과 상세 현장 탭이 연결된 challenge sim playable slice입니다.',
    nextStep: '남은 작업은 브라우저 샌드박스 실제 실행, 문제팩 난이도 검수, 커뮤니티 챌린지/랭킹용 제출 비교 UI를 강화하는 확장입니다.',
  },
  {
    slug: 'rail3d-sim',
    title: 'Rail 3D Sim',
