...
export const GAME_ROADMAP = [
  {
    ...
    priority: '1차 이식',
    scope: '카드 DB, 덱 빌더, 듀얼 샌드박스, 방 저장, 전적, 자동 플레이 보조, 기능별 탭 UI',
    summary: '턴, 페이즈, 소환, 세트, 전투, 체인, 덱 저장, 게임방 상태 저장, 전적 기록, 보드/패/로그 탭까지 붙은 카드 배틀 playable slice입니다.',
    nextStep: '원본 v13 카드 효과를 더 넓게 이식하고, 룰 설명/리플레이/멀티 동시성 검증을 강화합니다.',
  },
  {
    slug: 'ba-vanguard',
    title: 'BA Vanguard',
    ...
    priority: '1차 후보',
    scope: '카드 라이브러리, 덱 검사, 플레이테스트, 매치업 자동 실험, 저장/전적, 기능별 탭 UI',
    summary: '덱 구성 규칙, 라이드/콜/스트라이드/배틀 샌드박스, 간단 AI 진행, 매치업 자동 실험 리포트가 붙은 카드 배틀 playable slice입니다.',
    nextStep: '카드 효과 범위, 리플레이, 게임방 동기화 검증을 강화합니다.',
  },
  {
  ...
  },
  {
    ...
    subtitle: 'Idle RPG',
    priority: '장기 성장형',
    scope: '방치 정산, 장비, 타워, 미션, 강화, 분해, 상점, 성장 리포트, 저장/전적, 기능별 탭 UI',
    summary: '방치 정산과 반복 성장, 장비 프리셋, 자동 분해, 탑 상점, 성장 리포트까지 연결된 장기 성장형 playable slice입니다.',
    nextStep: '서버 계정 성장 데이터, 장기 밸런스, 원본 콘텐츠팩 기반 이벤트 확장을 강화합니다.',
  },
  {
    slug: 'ba-srpg',
    title: 'BA SRPG',
    ...
    priority: '장기 주력',
    scope: '그리드 전투, 캠페인 별 진행, Hard/VeryHard 미션, 타운 경제, 제작/상점, 의뢰, 저장/전적, 기능별 탭 UI',
    summary: '격자 이동, AP, 사거리, 엄폐, 적 턴, 자동 전투, Hard/VeryHard 해금 미션, 캠페인 별 진행, 타운 경제까지 연결한 전술 SRPG playable slice입니다.',
    nextStep: '전투 HUD 연출, 적 AI 가중치, 장기 밸런스와 추가 챕터 미션을 강화합니다.',
  },
  {
    slug: 'myanimecraft',
