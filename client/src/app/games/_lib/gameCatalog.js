...
export const GAME_ROADMAP = [
  {
    ...
    priority: '1차 이식',
    scope: '카드 DB, 덱 빌더, 듀얼 샌드박스, 방 저장, 전적, 자동 플레이 보조, 턴 어드바이저, 매치 리포트, 리플레이 타임라인, 체인 감사, 기능별 탭 UI',
    summary: '턴, 페이즈, 소환, 세트, 전투, 체인, 덱 저장, 게임방 상태 저장, 전적 기록, 보드/턴 판단/패/로그 탭, 매치 리포트와 턴별 리플레이 타임라인까지 붙은 카드 배틀 playable slice입니다.',
    nextStep: '원본 v13 카드 효과를 더 넓게 이식하고, 멀티 동시성 검증과 리플레이 파일 내보내기를 강화합니다.',
  },
  {
    slug: 'ba-vanguard',
    title: 'BA Vanguard',
    ...
    priority: '1차 후보',
    scope: '카드 라이브러리, 덱 검사, 플레이테스트, 라이브 전술 리포트, 리플레이 흐름 분석, 매치업 자동 실험, 저장/전적, 게임방 상태 저장, 기능별 탭 UI',
    summary: '덱 구성 규칙, 라이드/콜/스트라이드/배틀 샌드박스, 간단 AI 진행, 전술 리포트, 가드 감사가 포함된 리플레이 흐름 분석, 매치업 자동 실험 리포트, 게임방 상태 저장이 붙은 카드 배틀 playable slice입니다.',
    nextStep: '카드 효과 범위, 리플레이 파일 내보내기, 방 동시 편집 충돌 검증을 강화합니다.',
  },
  {
  ...
  },
  {
    ...
    subtitle: 'Idle RPG',
    priority: '장기 성장형',
    scope: '방치 정산, 장비, 타워, 미션, 강화, 분해, 상점, 일일 운영 플랜, 성장 리포트, 성장 로드맵, 저장/전적, 기능별 탭 UI',
    summary: '방치 정산과 반복 성장, 장비 프리셋, 자동 분해, 탑 상점, 즉시 실행 가능한 일일 운영 플랜, 오늘/주간/장기 로드맵까지 연결된 장기 성장형 playable slice입니다.',
  ...
  },
  {
    ...
    priority: '장기 주력',
    scope: '그리드 전투, 캠페인 별 진행, Hard/VeryHard 미션, 작전 브리핑, 전투 예측, AI 위협 리포트, 타운 경제, 제작/상점, 의뢰, 저장/전적, 기능별 탭 UI',
    summary: '격자 이동, AP, 사거리, 엄폐, 적 턴, 자동 전투, Hard/VeryHard 해금 미션, 작전 브리핑, 전투 중 적 턴 예상/아군 위험도/공격 후보 리포트까지 연결한 전술 SRPG playable slice입니다.',
    nextStep: '전투 연출, 장기 밸런스와 추가 챕터/적 패턴을 강화합니다.',
  },
  {
    slug: 'myanimecraft',
