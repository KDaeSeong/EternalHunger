...
export const GAME_ROADMAP = [
  ...
  },
  {
    ...
    priority: '1차 후보',
    scope: '카드 라이브러리, 덱 검사, 플레이테스트, 매치업 자동 실험, 저장/전적, 게임방 상태 저장, 기능별 탭 UI',
    summary: '덱 구성 규칙, 라이드/콜/스트라이드/배틀 샌드박스, 간단 AI 진행, 매치업 자동 실험 리포트, 게임방 상태 저장이 붙은 카드 배틀 playable slice입니다.',
