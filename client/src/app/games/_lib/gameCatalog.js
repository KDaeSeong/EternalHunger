...
export const GAME_ROADMAP = [
  {
    ...
    priority: '1차 이식',
    scope: '카드 DB, 덱 빌더, 듀얼 샌드박스, 방 저장, 전적, 자동 플레이 보조, 턴 어드바이저, 매치 리포트, 리플레이 타임라인, 체인 감사, JSON 리플레이 내보내기, 카드 효과 이식 감사, 게임방 동시성 감사, 기능별 탭 UI',
    summary: '턴, 페이즈, 소환, 세트, 전투, 체인, 덱 저장, 게임방 상태 저장, 전적 기록, 보드/턴 판단/패/로그 탭, 매치 리포트, 턴별 리플레이 타임라인, 감사 결과가 포함된 JSON 리플레이 내보내기, 카드 효과 커버리지와 방 revision 충돌 감사까지 붙은 카드 배틀 playable slice입니다.',
    nextStep: '완성 이후에는 원본 v13 카드 풀 추가 이식, 고급 멀티 관전, 외부 리플레이 공유 같은 선택형 확장만 남았습니다.',
  },
  {
    slug: 'ba-vanguard',
    title: 'BA Vanguard',
    ...
    priority: '1차 후보',
    scope: '카드 라이브러리, 덱 검사, 플레이테스트, 라이브 전술 리포트, 리플레이 흐름 분석, 매치업 자동 실험, JSON 리플레이 내보내기, 카드 타입/태그 이식 감사, 게임방 동시성 감사, 저장/전적, 게임방 상태 저장, 기능별 탭 UI',
    summary: '덱 구성 규칙, 라이드/콜/스트라이드/배틀 샌드박스, 간단 AI 진행, 전술 리포트, 가드 감사가 포함된 리플레이 흐름 분석, 매치업 자동 실험 리포트, 감사 결과가 포함된 JSON 리플레이 내보내기, 카드 타입/태그 커버리지와 방 revision 충돌 감사까지 붙은 카드 배틀 playable slice입니다.',
    nextStep: '완성 이후에는 원본 카드 풀 심화, 관전/리플레이 공유, 고급 AI 실험 같은 선택형 확장만 남았습니다.',
  },
  {
    slug: 'primitive-archive',
    title: 'Civilization Archive',
    subtitle: 'Tribe to Civilization',
    priority: '1차 완료권',
    scope: '채집, 사냥, 제작, 캠프, 연구, 장비, 자동 운영, 런 정산, 런 리포트, 최종 아카이브 기록서',
    summary: '부족 생존에서 후기 근대 문명 발전까지 이어지는 학생 파티 시뮬레이션을 사이트 플레이 화면으로 이식했고, 저장/전적/아카이브 목표/하루 자동 운영/위험 리포트/최종 기록서까지 연결했습니다.',
