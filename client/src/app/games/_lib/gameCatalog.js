...
export const GAME_ROADMAP = [
  {
    ...
    priority: '1차 이식',
    scope: '카드 DB, 덱 빌더, 듀얼 샌드박스, 방 저장, 전적, 자동 플레이 보조, 매치 리포트, 기능별 탭 UI',
    summary: '턴, 페이즈, 소환, 세트, 전투, 체인, 덱 저장, 게임방 상태 저장, 전적 기록, 보드/패/로그 탭, 매치 리포트까지 붙은 카드 배틀 playable slice입니다.',
