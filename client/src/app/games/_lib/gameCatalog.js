...
export const GAME_ROADMAP = [
  ...
  },
  {
    ...
    priority: '1차 후보',
    scope: '카드 라이브러리, 덱 검사, 플레이테스트, 저장/전적, 기능별 탭 UI',
    summary: '덱 구성 규칙, 라이드/콜/스트라이드/배틀 샌드박스, 간단 AI 진행이 붙은 플레이 가능 카드 배틀 slice입니다.',
    nextStep: '내 턴 자동 진행과 카드 효과 범위를 넓히고, 게임방 동기화 검증을 강화합니다.',
  },
  {
