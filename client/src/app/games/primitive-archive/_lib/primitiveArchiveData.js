...
export const TECH_TIER_DEFS = [
  ...
  { tier: 23, name: '산업 동력', era: 'MODERN_EARLY' },
  { tier: 24, name: '인쇄와 소총', era: 'MODERN_EARLY' },
  { tier: 25, name: '기계와 전기', era: 'MODERN_EARLY' },
  { tier: 26, name: '정밀 기록', era: 'MODERN_EARLY' },
  { tier: 27, name: '철도와 열역학', era: 'MODERN_EARLY' },
  { tier: 28, name: '전신과 강철포', era: 'MODERN_EARLY' },
  { tier: 29, name: '제강과 세균학', era: 'MODERN_EARLY' },
  { tier: 30, name: '전기 근대 전문화', era: 'MODERN_EARLY' },
  { tier: 31, name: '전력과 방역', era: 'MODERN_LATE' },
  { tier: 32, name: '기관총과 전화', era: 'MODERN_LATE' },
  { tier: 33, name: '연소와 원소', era: 'MODERN_LATE' },
  { tier: 34, name: '무연 화약과 녹음', era: 'MODERN_LATE' },
  { tier: 35, name: '전력망과 방사선', era: 'MODERN_LATE' },
  { tier: 36, name: '무선과 터빈', era: 'MODERN_LATE' },
  { tier: 37, name: '자동차와 냉장망', era: 'MODERN_LATE' },
  { tier: 38, name: '후기 근대 전문화', era: 'MODERN_LATE' },
];
...
export const CIVIC_TIER_DEFS = [
  ...
  { tier: 21, name: '산업과 공리', era: 'MODERN_EARLY' },
  { tier: 22, name: '국민과 출판', era: 'MODERN_EARLY' },
  { tier: 23, name: '공장과 위생', era: 'MODERN_EARLY' },
  { tier: 24, name: '교육과 자유', era: 'MODERN_EARLY' },
  { tier: 25, name: '도시와 노동', era: 'MODERN_EARLY' },
  { tier: 26, name: '전기 근대 사상', era: 'MODERN_EARLY' },
  { tier: 27, name: '기업과 사회 보장', era: 'MODERN_LATE' },
  { tier: 28, name: '동원과 대중 언론', era: 'MODERN_LATE' },
  { tier: 29, name: '표준과 복지 행정', era: 'MODERN_LATE' },
  { tier: 30, name: '국제법과 보통 교육', era: 'MODERN_LATE' },
  { tier: 31, name: '공공 규제와 노동', era: 'MODERN_LATE' },
  { tier: 32, name: '후기 근대 사회', era: 'MODERN_LATE' },
];
...
const RAW_TECH_TREE = [
  ...
  {
    id: 'ROTARY_STEAM_POWER', name: '회전식 증기기관', era: 'MODERN_EARLY', tier: 23, cost: 98, prereqs: ['EARLY_STEAM_ENGINE', 'ENLIGHTENMENT'], tags: ['CRAFT', 'SCIENCE'], branch: 'ENGINEERING',
    description: '왕복 운동을 안정적인 회전력으로 바꾸어 제작과 자원 운반의 생산성을 높입니다.',
    unlocks: { passives: ['MODERN_ENGINEERING_TECH_STACK'] },
    eureka: { type: 'actionSuccess', action: 'craft', count: 38, bonusPct: 0.25, desc: '제작 성공 38회로 회전축과 조속기 조정' },
  },
  {
    id: 'MODERN_CHEMISTRY', name: '근대 화학', era: 'MODERN_EARLY', tier: 23, cost: 98, prereqs: ['CLASSICAL_MECHANICS', 'SCIENTIFIC_SOCIETY'], tags: ['SCIENCE', 'CRAFT'], branch: 'NATURAL_PHILOSOPHY',
    description: '질량 측정과 새로운 원소 체계를 결합해 실험과 연구의 재현성을 높입니다.',
    unlocks: { passives: ['MODERN_SCIENCE_TECH_STACK'] },
    eureka: { type: 'surviveDays', count: 30, bonusPct: 0.25, desc: '30일 동안 물질 변화와 질량 기록 유지' },
  },
  {
    id: 'MECHANIZED_FARMING', name: '농업 기계화', era: 'MODERN_EARLY', tier: 23, cost: 98, prereqs: ['MODERN_AGRONOMY', 'PUBLIC_HEALTH'], tags: ['SURVIVAL', 'CRAFT'], branch: 'SURVIVAL',
    description: '파종과 수확 도구를 기계화해 채집 성공률과 식량 자원 수익을 높입니다.',
    unlocks: { passives: ['MODERN_SURVIVAL_TECH_STACK'] },
    eureka: { type: 'actionSuccess', action: 'gather', count: 38, bonusPct: 0.25, desc: '채집 성공 38회로 농기구 작업량 비교' },
  },
  {
    id: 'RIFLED_MUSKET', name: '강선식 머스킷', era: 'MODERN_EARLY', tier: 24, cost: 104, prereqs: ['SHIP_OF_THE_LINE', 'MODERN_CHEMISTRY'], tags: ['MILITARY', 'CRAFT'], branch: 'MILITARY',
    description: '총신의 강선과 규격 탄환으로 원거리 명중과 사냥 대응력을 높입니다.',
    unlocks: { passives: ['MODERN_MILITARY_TECH_STACK'] },
    eureka: { type: 'actionSuccess', action: 'hunt', count: 26, bonusPct: 0.25, desc: '사냥 성공 26회로 강선 탄도 기록 완성' },
  },
  {
    id: 'STEAM_PRINTING_PRESS', name: '증기 인쇄기', era: 'MODERN_EARLY', tier: 24, cost: 104, prereqs: ['COPPERPLATE_PRINTING', 'INDUSTRIAL_ENTREPRENEURSHIP'], tags: ['CRAFT', 'CULTURE'], branch: 'LITERATURE',
    description: '증기 동력으로 인쇄 속도와 발행량을 늘려 연구 기록과 문화 전파를 강화합니다.',
    unlocks: { passives: ['MODERN_MEDIA_TECH_STACK'] },
    eureka: { type: 'actionSuccess', action: 'craft', count: 40, bonusPct: 0.25, desc: '제작 성공 40회로 연속 인쇄 공정 확립' },
  },
  {
    id: 'MISSIONARY_MEDICINE', name: '선교 의학', era: 'MODERN_EARLY', tier: 24, cost: 104, prereqs: ['PHARMACOPOEIA', 'AGRARIAN_REFORM'], tags: ['SPIRITUAL', 'SURVIVAL'], branch: 'FAITH',
    description: '신앙 공동체의 진료와 약품 배급을 체계화해 회복과 구호 능력을 높입니다.',
    unlocks: { passives: ['MODERN_MEDICAL_TECH_STACK'] },
    eureka: { type: 'haveItem', itemId: 'herb_tonic', count: 5, bonusPct: 0.25, desc: '약초 달임 5개를 순회 진료용으로 비축' },
  },
  {
    id: 'POWER_LOOM', name: '동력 방직기', era: 'MODERN_EARLY', tier: 25, cost: 110, prereqs: ['ROTARY_STEAM_POWER', 'INDUSTRIAL_ENTREPRENEURSHIP'], tags: ['CRAFT', 'SCIENCE'], branch: 'ENGINEERING',
    description: '동력과 반복 기구로 직물 생산을 표준화해 제작과 캠프 작업 효율을 높입니다.',
    unlocks: { passives: ['MODERN_ENGINEERING_TECH_STACK'] },
    eureka: { type: 'actionSuccess', action: 'craft', count: 42, bonusPct: 0.25, desc: '제작 성공 42회로 북과 직조 속도 동기화' },
  },
  {
    id: 'ELECTROMAGNETISM', name: '전자기학', era: 'MODERN_EARLY', tier: 25, cost: 110, prereqs: ['MODERN_CHEMISTRY', 'UTILITARIANISM'], tags: ['SCIENCE'], branch: 'NATURAL_PHILOSOPHY',
    description: '전류와 자기장의 관계를 실험해 새로운 동력·통신 연구의 기반을 만듭니다.',
    unlocks: { passives: ['MODERN_SCIENCE_TECH_STACK'] },
    eureka: { type: 'weatherTypes', count: 5, bonusPct: 0.25, desc: '날씨 5종에서 전기·자기 변화 관찰' },
  },
  {
    id: 'VACCINATION', name: '예방 접종', era: 'MODERN_EARLY', tier: 25, cost: 110, prereqs: ['MISSIONARY_MEDICINE', 'AGRARIAN_REFORM'], tags: ['SURVIVAL', 'SCIENCE'], branch: 'SURVIVAL',
    description: '예방 접종 기록으로 감염 위험을 낮추고 휴식과 치료의 회복을 강화합니다.',
    unlocks: { passives: ['MODERN_SURVIVAL_TECH_STACK'] },
    eureka: { type: 'haveItem', itemId: 'herb_tonic', count: 5, bonusPct: 0.25, desc: '약초 달임 5개와 예방 처치 기록 준비' },
  },
  {
    id: 'BREECH_LOADING_RIFLE', name: '후장식 소총', era: 'MODERN_EARLY', tier: 26, cost: 116, prereqs: ['RIFLED_MUSKET', 'MASS_CONSCRIPTION'], tags: ['MILITARY', 'CRAFT'], branch: 'MILITARY',
    description: '후장식 장전과 규격 탄약으로 반복 사격과 위험 대응 속도를 높입니다.',
    unlocks: { passives: ['MODERN_MILITARY_TECH_STACK'] },
    eureka: { type: 'actionSuccess', action: 'hunt', count: 28, bonusPct: 0.25, desc: '사냥 성공 28회로 장전 절차 단축' },
  },
  {
    id: 'PHOTOGRAPHY', name: '사진술', era: 'MODERN_EARLY', tier: 26, cost: 116, prereqs: ['STEAM_PRINTING_PRESS', 'POSITIVISM'], tags: ['CULTURE', 'SCIENCE'], branch: 'LITERATURE',
    description: '빛과 감광 재료로 순간을 보존해 기록의 정확성과 문화 점수를 높입니다.',
    unlocks: { passives: ['MODERN_MEDIA_TECH_STACK'] },
    eureka: { type: 'actionSuccess', action: 'craft', count: 44, bonusPct: 0.25, desc: '제작 성공 44회로 감광판 노출 시간 조정' },
  },
  {
    id: 'HOSPITAL_SANITATION', name: '병원 위생', era: 'MODERN_EARLY', tier: 26, cost: 116, prereqs: ['MISSIONARY_MEDICINE', 'PUBLIC_SANITATION'], tags: ['SPIRITUAL', 'SURVIVAL'], branch: 'FAITH',
    description: '병동 청결과 환자 분리를 표준화해 공동체 치료와 회복을 강화합니다.',
    unlocks: { passives: ['MODERN_MEDICAL_TECH_STACK'] },
    eureka: { type: 'haveItem', itemId: 'herb_tonic', count: 6, bonusPct: 0.25, desc: '약초 달임 6개와 병동 위생 기록 비축' },
  },
  {
    id: 'RAILWAY_ENGINEERING', name: '철도 공학', era: 'MODERN_EARLY', tier: 27, cost: 122, prereqs: ['POWER_LOOM', 'FACTORY_SYSTEM'], tags: ['CRAFT', 'SCIENCE'], branch: 'ENGINEERING',
    description: '철제 궤도와 증기 견인으로 자원 운송과 캠프 생산을 크게 높입니다.',
    unlocks: { passives: ['MODERN_ENGINEERING_TECH_STACK'] },
    eureka: { type: 'actionSuccess', action: 'craft', count: 46, bonusPct: 0.25, desc: '제작 성공 46회로 궤간과 차륜 규격 통일' },
  },
  {
    id: 'THERMODYNAMICS', name: '열역학', era: 'MODERN_EARLY', tier: 27, cost: 122, prereqs: ['ELECTROMAGNETISM', 'POSITIVISM'], tags: ['SCIENCE'], branch: 'NATURAL_PHILOSOPHY',
    description: '열과 일의 관계를 수량화해 연구와 기계 효율의 이론적 기반을 세웁니다.',
    unlocks: { passives: ['MODERN_SCIENCE_TECH_STACK'] },
    eureka: { type: 'surviveDays', count: 34, bonusPct: 0.25, desc: '34일 동안 열·압력·작업량 측정' },
  },
  {
    id: 'FOOD_CANNING', name: '통조림', era: 'MODERN_EARLY', tier: 27, cost: 122, prereqs: ['VACCINATION', 'PUBLIC_SANITATION'], tags: ['SURVIVAL', 'CRAFT'], branch: 'SURVIVAL',
    description: '밀봉과 가열 보존으로 식량 손실을 줄이고 장기 생존 자원 수익을 높입니다.',
    unlocks: { passives: ['MODERN_SURVIVAL_TECH_STACK'] },
    eureka: { type: 'actionSuccess', action: 'gather', count: 42, bonusPct: 0.25, desc: '채집 성공 42회로 보존 식재료 선별' },
  },
  {
    id: 'STEEL_ARTILLERY', name: '강철제 포병', era: 'MODERN_EARLY', tier: 28, cost: 128, prereqs: ['BREECH_LOADING_RIFLE', 'GENERAL_STAFF'], tags: ['MILITARY', 'CRAFT'], branch: 'MILITARY',
    description: '강철 포신과 표준 포탄으로 사냥 화력과 위험 행동 방어를 강화합니다.',
    unlocks: { passives: ['MODERN_MILITARY_TECH_STACK'] },
    eureka: { type: 'actionSuccess', action: 'hunt', count: 30, bonusPct: 0.25, desc: '사냥 성공 30회로 포격 제원표 작성' },
  },
  {
    id: 'TELEGRAPHY', name: '전신', era: 'MODERN_EARLY', tier: 28, cost: 128, prereqs: ['PHOTOGRAPHY', 'PUBLIC_EDUCATION'], tags: ['CULTURE', 'SCIENCE'], branch: 'LITERATURE',
    description: '전기 신호를 부호화해 소식과 연구 기록을 먼 거리까지 빠르게 전달합니다.',
    unlocks: { passives: ['MODERN_MEDIA_TECH_STACK'] },
    eureka: { type: 'actionSuccess', action: 'craft', count: 48, bonusPct: 0.25, desc: '제작 성공 48회로 신호 부호와 회로 확립' },
  },
  {
    id: 'HUMANITARIAN_LOGISTICS', name: '구호 물류', era: 'MODERN_EARLY', tier: 28, cost: 128, prereqs: ['HOSPITAL_SANITATION', 'RELIGIOUS_LIBERTY'], tags: ['SPIRITUAL', 'SURVIVAL'], branch: 'FAITH',
    description: '신앙과 출신을 가리지 않는 구호망으로 식량·약품 전달과 회복을 강화합니다.',
    unlocks: { passives: ['MODERN_MEDICAL_TECH_STACK'] },
    eureka: { type: 'haveItem', itemId: 'herb_tonic', count: 6, bonusPct: 0.25, desc: '약초 달임 6개를 구호 물자로 분산 비축' },
  },
  {
    id: 'BESSEMER_STEEL', name: '전로 제강', era: 'MODERN_EARLY', tier: 29, cost: 134, prereqs: ['RAILWAY_ENGINEERING', 'MUNICIPAL_GOVERNMENT'], tags: ['CRAFT', 'SCIENCE'], branch: 'ENGINEERING',
    description: '용선의 불순물을 대량 제거해 철도·기계·건설용 강철 생산을 확대합니다.',
    unlocks: { passives: ['MODERN_ENGINEERING_TECH_STACK'] },
    eureka: { type: 'actionSuccess', action: 'craft', count: 50, bonusPct: 0.25, desc: '제작 성공 50회로 송풍과 탄소량 조정' },
  },
  {
    id: 'GERM_THEORY', name: '세균설', era: 'MODERN_EARLY', tier: 29, cost: 134, prereqs: ['THERMODYNAMICS', 'PROFESSIONAL_SCIENCE'], tags: ['SCIENCE', 'SURVIVAL'], branch: 'NATURAL_PHILOSOPHY',
    description: '질병의 미생물 원인을 검증해 위생·예방·치료 연구의 정확성을 높입니다.',
    unlocks: { passives: ['MODERN_SCIENCE_TECH_STACK'] },
    eureka: { type: 'surviveDays', count: 36, bonusPct: 0.25, desc: '36일 동안 감염과 회복 사례 비교' },
  },
  {
    id: 'REFRIGERATION', name: '냉장 기술', era: 'MODERN_EARLY', tier: 29, cost: 134, prereqs: ['FOOD_CANNING', 'LABOR_PROTECTION'], tags: ['SURVIVAL', 'SCIENCE'], branch: 'SURVIVAL',
    description: '열을 이동시켜 식품과 약품의 보존 기간을 늘리고 생존 자원 손실을 줄입니다.',
    unlocks: { passives: ['MODERN_SURVIVAL_TECH_STACK'] },
    eureka: { type: 'actionSuccess', action: 'gather', count: 44, bonusPct: 0.25, desc: '채집 성공 44회로 저온 보존 효과 비교' },
  },
  {
    id: 'IRONCLAD_SHIPBUILDING', name: '철갑함', era: 'MODERN_EARLY', tier: 30, cost: 140, prereqs: ['STEEL_ARTILLERY', 'NATION_STATE'], tags: ['MILITARY', 'CRAFT'], branch: 'MILITARY',
    description: '증기 추진과 철제 장갑을 결합해 위험 행동과 악천후에 대한 방어를 높입니다.',
    unlocks: { passives: ['MODERN_MILITARY_TECH_STACK'] },
    eureka: { type: 'actionSuccess', action: 'hunt', count: 32, bonusPct: 0.25, desc: '사냥 성공 32회로 장갑·화력 운용 훈련' },
  },
  {
    id: 'MASS_PUBLISHING', name: '대중 출판', era: 'MODERN_EARLY', tier: 30, cost: 140, prereqs: ['TELEGRAPHY', 'LIBERALISM'], tags: ['CULTURE', 'CRAFT'], branch: 'LITERATURE',
    description: '고속 인쇄와 통신망으로 지식·문학·뉴스를 대중에게 널리 보급합니다.',
    unlocks: { passives: ['MODERN_MEDIA_TECH_STACK'] },
    eureka: { type: 'actionSuccess', action: 'craft', count: 52, bonusPct: 0.25, desc: '제작 성공 52회로 대량 발행 공정 완성' },
  },
  {
    id: 'MODERN_HOSPITAL', name: '근대 병원', era: 'MODERN_EARLY', tier: 30, cost: 140, prereqs: ['HUMANITARIAN_LOGISTICS', 'HUMANITARIANISM'], tags: ['SPIRITUAL', 'SURVIVAL'], branch: 'FAITH',
    description: '전문 진료·간호·위생·구호를 하나의 기관으로 묶어 공동체 회복을 극대화합니다.',
    unlocks: { passives: ['MODERN_MEDICAL_TECH_STACK'] },
    eureka: { type: 'haveItem', itemId: 'herb_tonic', count: 7, bonusPct: 0.25, desc: '약초 달임 7개와 환자 기록을 병원용으로 비축' },
  },
  {
    id: 'INDUSTRIAL_ENTREPRENEURSHIP', name: '산업 기업', era: 'MODERN_EARLY', tier: 21, cost: 102, prereqs: ['CONSTITUTIONAL_ASSEMBLY', 'ROTARY_STEAM_POWER'], tags: ['CIVICS', 'CRAFT'], branch: 'ENGINEERING',
    description: '자본·기술·노동을 장기 사업으로 조직해 생산과 캠프 성장을 강화합니다.',
    unlocks: { passives: ['MODERN_ENGINEERING_CIVIC_STACK'] },
    inspiration: { type: 'campLevel', key: 'workbenchLevel', count: 3, bonusPct: 0.25, desc: '작업대 Lv.3에서 생산 장부 운영' },
  },
  {
    id: 'UTILITARIANISM', name: '공리주의', era: 'MODERN_EARLY', tier: 21, cost: 102, prereqs: ['ENLIGHTENMENT', 'MODERN_CHEMISTRY'], tags: ['CIVICS', 'SCIENCE'], branch: 'NATURAL_PHILOSOPHY',
    description: '공동체 선택의 결과를 비교해 연구와 제도의 효용을 수량적으로 평가합니다.',
    unlocks: { passives: ['MODERN_SCIENCE_CIVIC_STACK'] },
    inspiration: { type: 'surviveDays', count: 32, bonusPct: 0.25, desc: '32일 동안 공동체 선택과 결과 기록' },
  },
  {
    id: 'AGRARIAN_REFORM', name: '농지 개혁', era: 'MODERN_EARLY', tier: 21, cost: 102, prereqs: ['PUBLIC_HEALTH', 'MECHANIZED_FARMING'], tags: ['CIVICS', 'SURVIVAL'], branch: 'SURVIVAL',
    description: '토지 이용과 생산 의무를 조정해 식량 확보와 농촌 공동체의 안정성을 높입니다.',
    unlocks: { passives: ['MODERN_SURVIVAL_CIVIC_STACK'] },
    inspiration: { type: 'actionSuccess', action: 'gather', count: 40, bonusPct: 0.25, desc: '채집 성공 40회의 토지 생산 기록' },
  },
  {
    id: 'MASS_CONSCRIPTION', name: '국민 징병제', era: 'MODERN_EARLY', tier: 22, cost: 108, prereqs: ['STANDING_ARMY', 'RIFLED_MUSKET'], tags: ['CIVICS', 'MILITARY'], branch: 'MILITARY',
    description: '국민 단위의 훈련·동원·보급으로 파티 정원과 위험 대응 능력을 높입니다.',
    unlocks: { passives: ['MODERN_MILITARY_CIVIC_STACK'] },
    inspiration: { type: 'actionSuccess', action: 'hunt', count: 24, bonusPct: 0.25, desc: '사냥 성공 24회의 동원 훈련 기록' },
  },
  {
    id: 'FREEDOM_OF_PRESS', name: '출판의 자유', era: 'MODERN_EARLY', tier: 22, cost: 108, prereqs: ['CONSTITUTIONAL_ASSEMBLY', 'STEAM_PRINTING_PRESS'], tags: ['CIVICS', 'CULTURE'], branch: 'LITERATURE',
    description: '검열 없이 기록과 의견을 교환해 문화·영감·로그 보존을 강화합니다.',
    unlocks: { passives: ['MODERN_MEDIA_CIVIC_STACK'] },
    inspiration: { type: 'campFireDays', count: 24, bonusPct: 0.25, desc: '자유 토론과 낭독 24회' },
  },
  {
    id: 'EVANGELICAL_REVIVAL', name: '신앙 부흥 운동', era: 'MODERN_EARLY', tier: 22, cost: 108, prereqs: ['ENLIGHTENED_THEOLOGY', 'MISSIONARY_MEDICINE'], tags: ['SPIRITUAL', 'CULTURE'], branch: 'FAITH',
    description: '자발적 신앙 공동체와 구호 활동으로 회복·문화·상호 돌봄을 강화합니다.',
    unlocks: { passives: ['MODERN_FAITH_CIVIC_STACK'] },
    inspiration: { type: 'haveItem', itemId: 'herb_tonic', count: 5, bonusPct: 0.25, desc: '약초 달임 5개를 자선 진료용으로 비축' },
  },
  {
    id: 'FACTORY_SYSTEM', name: '공장제', era: 'MODERN_EARLY', tier: 23, cost: 114, prereqs: ['INDUSTRIAL_ENTREPRENEURSHIP', 'POWER_LOOM'], tags: ['CIVICS', 'CRAFT'], branch: 'ENGINEERING',
    description: '동력·기계·분업 노동을 한 장소에 조직해 생산 수익과 캠프 점수를 높입니다.',
    unlocks: { passives: ['MODERN_ENGINEERING_CIVIC_STACK'] },
    inspiration: { type: 'actionSuccess', action: 'craft', count: 44, bonusPct: 0.25, desc: '제작 성공 44회의 분업 공정 기록' },
  },
  {
    id: 'POSITIVISM', name: '실증주의', era: 'MODERN_EARLY', tier: 23, cost: 114, prereqs: ['UTILITARIANISM', 'ELECTROMAGNETISM'], tags: ['CIVICS', 'SCIENCE'], branch: 'NATURAL_PHILOSOPHY',
    description: '관찰 가능한 사실과 검증 가능한 법칙을 사회 연구의 기준으로 삼습니다.',
    unlocks: { passives: ['MODERN_SCIENCE_CIVIC_STACK'] },
    inspiration: { type: 'weatherTypes', count: 5, bonusPct: 0.25, desc: '자연 현상 5종을 동일 기준으로 비교' },
  },
  {
    id: 'PUBLIC_SANITATION', name: '위생 행정', era: 'MODERN_EARLY', tier: 23, cost: 114, prereqs: ['AGRARIAN_REFORM', 'VACCINATION'], tags: ['CIVICS', 'SURVIVAL'], branch: 'SURVIVAL',
    description: '상수·하수·폐기물·예방 기준을 행정으로 관리해 공동체 생존을 강화합니다.',
    unlocks: { passives: ['MODERN_SURVIVAL_CIVIC_STACK'] },
    inspiration: { type: 'campLevel', key: 'shelterLevel', count: 3, bonusPct: 0.25, desc: '주거 Lv.3에서 위생 구역 운영' },
  },
  {
    id: 'GENERAL_STAFF', name: '참모본부', era: 'MODERN_EARLY', tier: 24, cost: 120, prereqs: ['MASS_CONSCRIPTION', 'BREECH_LOADING_RIFLE'], tags: ['CIVICS', 'MILITARY'], branch: 'MILITARY',
    description: '정보·작전·보급 계획을 전문 조직으로 통합해 사냥과 위험 대응을 강화합니다.',
    unlocks: { passives: ['MODERN_MILITARY_CIVIC_STACK'] },
    inspiration: { type: 'actionSuccess', action: 'hunt', count: 28, bonusPct: 0.25, desc: '사냥 성공 28회의 작전·보급 계획 정리' },
  },
  {
    id: 'PUBLIC_EDUCATION', name: '공교육', era: 'MODERN_EARLY', tier: 24, cost: 120, prereqs: ['FREEDOM_OF_PRESS', 'PHOTOGRAPHY'], tags: ['CIVICS', 'CULTURE'], branch: 'LITERATURE',
    description: '기초 문해와 공통 지식을 널리 가르쳐 연구·문화·기록 역량을 높입니다.',
    unlocks: { passives: ['MODERN_MEDIA_CIVIC_STACK'] },
    inspiration: { type: 'haveItem', itemId: 'book_craft_guide', count: 1, bonusPct: 0.25, desc: '제작 안내서로 공통 교재 편찬' },
  },
  {
    id: 'RELIGIOUS_LIBERTY', name: '종교의 자유', era: 'MODERN_EARLY', tier: 24, cost: 120, prereqs: ['EVANGELICAL_REVIVAL', 'HOSPITAL_SANITATION'], tags: ['SPIRITUAL', 'CIVICS'], branch: 'FAITH',
    description: '신앙의 선택과 양심을 제도로 보호해 공동체 갈등을 줄이고 회복을 높입니다.',
    unlocks: { passives: ['MODERN_FAITH_CIVIC_STACK'] },
    inspiration: { type: 'surviveDays', count: 36, bonusPct: 0.25, desc: '36일 동안 서로 다른 신앙 공동체 공존' },
  },
  {
    id: 'MUNICIPAL_GOVERNMENT', name: '도시 행정', era: 'MODERN_EARLY', tier: 25, cost: 126, prereqs: ['FACTORY_SYSTEM', 'RAILWAY_ENGINEERING'], tags: ['CIVICS', 'CRAFT'], branch: 'ENGINEERING',
    description: '교통·위생·시설·예산을 도시 단위로 조정해 자원 수익과 캠프 점수를 높입니다.',
    unlocks: { passives: ['MODERN_ENGINEERING_CIVIC_STACK'] },
    inspiration: { type: 'campLevel', key: 'workbenchLevel', count: 3, bonusPct: 0.25, desc: '작업대 Lv.3에서 도시 시설 장부 운영' },
  },
  {
    id: 'PROFESSIONAL_SCIENCE', name: '전문 과학', era: 'MODERN_EARLY', tier: 25, cost: 126, prereqs: ['POSITIVISM', 'THERMODYNAMICS'], tags: ['CIVICS', 'SCIENCE'], branch: 'NATURAL_PHILOSOPHY',
    description: '전문 교육·학회·실험실을 연결해 연구와 발견 보너스를 강화합니다.',
    unlocks: { passives: ['MODERN_SCIENCE_CIVIC_STACK'] },
    inspiration: { type: 'campLevel', key: 'libraryShelfLevel', count: 1, bonusPct: 0.25, desc: '서가에서 전문 연구 보고회 운영' },
  },
  {
    id: 'LABOR_PROTECTION', name: '노동 보호', era: 'MODERN_EARLY', tier: 25, cost: 126, prereqs: ['PUBLIC_SANITATION', 'FOOD_CANNING'], tags: ['CIVICS', 'SURVIVAL'], branch: 'SURVIVAL',
    description: '작업 시간과 안전 기준을 정해 부상·피로·생존 압력을 줄입니다.',
    unlocks: { passives: ['MODERN_SURVIVAL_CIVIC_STACK'] },
    inspiration: { type: 'actionFail', action: 'craft', count: 10, bonusPct: 0.25, desc: '제작 실패 10회의 작업 사고 원인 조사' },
  },
  {
    id: 'NATION_STATE', name: '국민 국가', era: 'MODERN_EARLY', tier: 26, cost: 132, prereqs: ['GENERAL_STAFF', 'STEEL_ARTILLERY'], tags: ['CIVICS', 'MILITARY'], branch: 'MILITARY',
    description: '공통 법·행정·동원 체계로 넓은 공동체를 조직해 파티 정원과 방어를 높입니다.',
    unlocks: { passives: ['MODERN_MILITARY_CIVIC_STACK'] },
    inspiration: { type: 'actionSuccess', action: 'hunt', count: 32, bonusPct: 0.25, desc: '사냥 성공 32회의 전국 단위 동원 기록' },
  },
  {
    id: 'LIBERALISM', name: '자유주의', era: 'MODERN_EARLY', tier: 26, cost: 132, prereqs: ['PUBLIC_EDUCATION', 'TELEGRAPHY'], tags: ['CIVICS', 'CULTURE'], branch: 'LITERATURE',
    description: '개인의 자유와 공개 토론을 제도화해 문화·영감·기록 보존을 강화합니다.',
    unlocks: { passives: ['MODERN_MEDIA_CIVIC_STACK'] },
    inspiration: { type: 'campFireDays', count: 30, bonusPct: 0.25, desc: '자유 토론과 공개 논쟁 30회' },
  },
  {
    id: 'HUMANITARIANISM', name: '인도주의', era: 'MODERN_EARLY', tier: 26, cost: 132, prereqs: ['RELIGIOUS_LIBERTY', 'HUMANITARIAN_LOGISTICS'], tags: ['SPIRITUAL', 'CIVICS'], branch: 'FAITH',
    description: '출신과 신앙을 넘어 인간의 존엄을 보호해 구호와 공동체 회복을 강화합니다.',
    unlocks: { passives: ['MODERN_FAITH_CIVIC_STACK'] },
    inspiration: { type: 'haveItem', itemId: 'herb_tonic', count: 7, bonusPct: 0.25, desc: '약초 달임 7개를 보편 구호품으로 비축' },
  },
  {
    id: 'ELECTRIC_GENERATION', name: '발전기', era: 'MODERN_LATE', tier: 31, cost: 146, prereqs: ['BESSEMER_STEEL', 'ELECTROMAGNETISM'], tags: ['CRAFT', 'SCIENCE'], branch: 'ENGINEERING',
    description: '전자기 유도를 지속적인 회전 동력과 결합해 캠프 생산과 연구에 쓸 전력을 만듭니다.',
    unlocks: { passives: ['MODERN_ENGINEERING_TECH_STACK'] },
    eureka: { type: 'actionSuccess', action: 'craft', count: 54, bonusPct: 0.25, desc: '제작 성공 54회로 회전축과 코일 규격 조정' },
  },
  {
    id: 'ORGANIC_CHEMISTRY', name: '유기 화학', era: 'MODERN_LATE', tier: 31, cost: 146, prereqs: ['MODERN_CHEMISTRY', 'GERM_THEORY'], tags: ['SCIENCE', 'CRAFT'], branch: 'NATURAL_PHILOSOPHY',
    description: '탄소 화합물의 구조와 반응을 분류해 의약품·염료·연료 연구의 재현성을 높입니다.',
    unlocks: { passives: ['MODERN_SCIENCE_TECH_STACK'] },
    eureka: { type: 'surviveDays', count: 38, bonusPct: 0.25, desc: '38일 동안 발효·연료·약재 반응 기록 비교' },
  },
  {
    id: 'ANTISEPTIC_SURGERY', name: '무균 수술', era: 'MODERN_LATE', tier: 31, cost: 146, prereqs: ['GERM_THEORY', 'MODERN_HOSPITAL'], tags: ['SURVIVAL', 'SCIENCE'], branch: 'SURVIVAL',
    description: '수술 도구와 상처를 소독하고 감염 경로를 차단해 치료와 휴식 회복을 강화합니다.',
    unlocks: { passives: ['MODERN_SURVIVAL_TECH_STACK'] },
    eureka: { type: 'haveItem', itemId: 'herb_tonic', count: 8, bonusPct: 0.25, desc: '약초 달임 8개와 환자 회복 기록 대조' },
  },
  {
    id: 'MACHINE_GUN', name: '기관총', era: 'MODERN_LATE', tier: 32, cost: 152, prereqs: ['STEEL_ARTILLERY', 'GENERAL_STAFF'], tags: ['MILITARY', 'CRAFT'], branch: 'MILITARY',
    description: '연속 급탄과 자동 장전 구조로 위험 대응 화력을 높이고 사냥 실패 피해를 줄입니다.',
    unlocks: { passives: ['MODERN_MILITARY_TECH_STACK'] },
    eureka: { type: 'actionSuccess', action: 'hunt', count: 34, bonusPct: 0.25, desc: '사냥 성공 34회로 급탄 불량과 과열 기록 분석' },
  },
  {
    id: 'TELEPHONE', name: '전화', era: 'MODERN_LATE', tier: 32, cost: 152, prereqs: ['TELEGRAPHY', 'ELECTRIC_GENERATION'], tags: ['CULTURE', 'SCIENCE'], branch: 'LITERATURE',
    description: '목소리를 전기 신호로 바꾸어 멀리 전달함으로써 기록·지휘·공동체 소통을 빠르게 합니다.',
    unlocks: { passives: ['MODERN_MEDIA_TECH_STACK'] },
    eureka: { type: 'actionSuccess', action: 'craft', count: 56, bonusPct: 0.25, desc: '제작 성공 56회로 진동판과 송수신 회로 조정' },
  },
  {
    id: 'DISTRICT_NURSING', name: '지역 간호', era: 'MODERN_LATE', tier: 32, cost: 152, prereqs: ['MODERN_HOSPITAL', 'HUMANITARIANISM'], tags: ['SPIRITUAL', 'SURVIVAL'], branch: 'FAITH',
    description: '훈련된 간호 인력을 지역별로 배치해 치료가 캠프 밖의 취약한 공동체까지 닿게 합니다.',
    unlocks: { passives: ['MODERN_MEDICAL_TECH_STACK'] },
    eureka: { type: 'haveItem', itemId: 'herb_tonic', count: 8, bonusPct: 0.25, desc: '약초 달임 8개를 지역 방문 간호 꾸러미로 편성' },
  },
  {
    id: 'INTERNAL_COMBUSTION_ENGINE', name: '내연 기관', era: 'MODERN_LATE', tier: 33, cost: 158, prereqs: ['THERMODYNAMICS', 'ORGANIC_CHEMISTRY'], tags: ['CRAFT', 'SCIENCE'], branch: 'ENGINEERING',
    description: '실린더 안에서 연료를 폭발시켜 작고 강한 동력을 얻고 생산과 운송 효율을 높입니다.',
    unlocks: { passives: ['MODERN_ENGINEERING_TECH_STACK'] },
    eureka: { type: 'actionSuccess', action: 'craft', count: 58, bonusPct: 0.25, desc: '제작 성공 58회로 점화·압축·냉각 주기 완성' },
  },
  {
    id: 'PERIODIC_LAW', name: '주기율', era: 'MODERN_LATE', tier: 33, cost: 158, prereqs: ['ORGANIC_CHEMISTRY', 'PROFESSIONAL_SCIENCE'], tags: ['SCIENCE'], branch: 'NATURAL_PHILOSOPHY',
    description: '원소를 성질과 질량의 규칙으로 배열해 미지 물질과 반응 결과를 예측합니다.',
    unlocks: { passives: ['MODERN_SCIENCE_TECH_STACK'] },
    eureka: { type: 'weatherTypes', count: 5, bonusPct: 0.25, desc: '다섯 날씨에서 수집한 광물·용액 성질 분류' },
  },
  {
    id: 'PASTEURIZATION', name: '저온 살균', era: 'MODERN_LATE', tier: 33, cost: 158, prereqs: ['GERM_THEORY', 'FOOD_CANNING'], tags: ['SURVIVAL', 'SCIENCE'], branch: 'SURVIVAL',
    description: '식품을 일정 온도로 가열해 부패 미생물을 줄이고 장기 생존 식량의 안전성을 높입니다.',
    unlocks: { passives: ['MODERN_SURVIVAL_TECH_STACK'] },
    eureka: { type: 'actionSuccess', action: 'gather', count: 46, bonusPct: 0.25, desc: '채집 성공 46회의 식품 부패와 가열 기록 비교' },
  },
  {
    id: 'SMOKELESS_POWDER', name: '무연 화약', era: 'MODERN_LATE', tier: 34, cost: 164, prereqs: ['MACHINE_GUN', 'ORGANIC_CHEMISTRY'], tags: ['MILITARY', 'CRAFT'], branch: 'MILITARY',
    description: '연기와 잔류물을 줄인 추진약으로 반복 사격의 시야·신뢰성·위험 대응력을 높입니다.',
    unlocks: { passives: ['MODERN_MILITARY_TECH_STACK'] },
    eureka: { type: 'actionSuccess', action: 'hunt', count: 36, bonusPct: 0.25, desc: '사냥 성공 36회로 추진약 압력과 잔류물 비교' },
  },
  {
    id: 'PHONOGRAPH', name: '축음기', era: 'MODERN_LATE', tier: 34, cost: 164, prereqs: ['TELEPHONE', 'MASS_PUBLISHING'], tags: ['CULTURE', 'CRAFT'], branch: 'LITERATURE',
    description: '소리를 홈의 진동으로 기록하고 재생해 구전·음악·증언을 오래 보존합니다.',
    unlocks: { passives: ['MODERN_MEDIA_TECH_STACK'] },
    eureka: { type: 'actionSuccess', action: 'craft', count: 60, bonusPct: 0.25, desc: '제작 성공 60회로 침압과 회전 속도 조정' },
  },
  {
    id: 'BACTERIOLOGICAL_LAB', name: '세균 연구소', era: 'MODERN_LATE', tier: 34, cost: 164, prereqs: ['ANTISEPTIC_SURGERY', 'DISTRICT_NURSING'], tags: ['SPIRITUAL', 'SCIENCE'], branch: 'FAITH',
    description: '배양·염색·격리 절차를 표준화해 감염 원인을 찾고 공동체 방역을 강화합니다.',
    unlocks: { passives: ['MODERN_MEDICAL_TECH_STACK'] },
    eureka: { type: 'haveItem', itemId: 'herb_tonic', count: 9, bonusPct: 0.25, desc: '약초 달임 9개와 감염 환자 표본 장부 대조' },
  },
  {
    id: 'ELECTRIC_GRID', name: '전력망', era: 'MODERN_LATE', tier: 35, cost: 170, prereqs: ['ELECTRIC_GENERATION', 'INTERNAL_COMBUSTION_ENGINE'], tags: ['CRAFT', 'SCIENCE'], branch: 'ENGINEERING',
    description: '발전·변전·배전 설비를 연결해 캠프 전체에 안정적으로 동력과 조명을 공급합니다.',
    unlocks: { passives: ['MODERN_ENGINEERING_TECH_STACK'] },
    eureka: { type: 'actionSuccess', action: 'craft', count: 62, bonusPct: 0.25, desc: '제작 성공 62회로 전압 강하와 배전 손실 기록' },
  },
  {
    id: 'X_RAY_IMAGING', name: '엑스선', era: 'MODERN_LATE', tier: 35, cost: 170, prereqs: ['PERIODIC_LAW', 'ELECTRIC_GENERATION'], tags: ['SCIENCE', 'SURVIVAL'], branch: 'NATURAL_PHILOSOPHY',
    description: '보이지 않는 방사선을 이용해 몸과 물질 내부를 살피고 진단과 연구의 정확도를 높입니다.',
    unlocks: { passives: ['MODERN_SCIENCE_TECH_STACK'] },
    eureka: { type: 'surviveDays', count: 42, bonusPct: 0.25, desc: '42일 동안 방전관 투과 실험과 감광판 기록 축적' },
  },
  {
    id: 'ARTIFICIAL_FERTILIZER', name: '화학 비료', era: 'MODERN_LATE', tier: 35, cost: 170, prereqs: ['ORGANIC_CHEMISTRY', 'MECHANIZED_FARMING'], tags: ['SURVIVAL', 'SCIENCE'], branch: 'SURVIVAL',
    description: '토양의 질소·인·칼륨 균형을 조절해 식량 수익과 흉년 대응력을 높입니다.',
    unlocks: { passives: ['MODERN_SURVIVAL_TECH_STACK'] },
    eureka: { type: 'actionSuccess', action: 'gather', count: 50, bonusPct: 0.25, desc: '채집 성공 50회의 토양별 수확량 비교' },
  },
  {
    id: 'TURBINE_WARSHIP', name: '터빈 전함', era: 'MODERN_LATE', tier: 36, cost: 176, prereqs: ['IRONCLAD_SHIPBUILDING', 'SMOKELESS_POWDER'], tags: ['MILITARY', 'CRAFT'], branch: 'MILITARY',
    description: '증기 터빈과 일체형 대구경 포대를 결합해 장거리 위험 대응과 방어를 강화합니다.',
    unlocks: { passives: ['MODERN_MILITARY_TECH_STACK'] },
    eureka: { type: 'actionSuccess', action: 'hunt', count: 38, bonusPct: 0.25, desc: '사냥 성공 38회로 추적·사거리·보급 계획 통합' },
  },
  {
    id: 'WIRELESS_TELEGRAPHY', name: '무선 전신', era: 'MODERN_LATE', tier: 36, cost: 176, prereqs: ['TELEPHONE', 'ELECTRIC_GRID'], tags: ['CULTURE', 'SCIENCE'], branch: 'LITERATURE',
    description: '전파로 신호를 보내 선로가 없는 지역과 이동 중인 집단까지 기록과 명령을 전달합니다.',
    unlocks: { passives: ['MODERN_MEDIA_TECH_STACK'] },
    eureka: { type: 'actionSuccess', action: 'craft', count: 64, bonusPct: 0.25, desc: '제작 성공 64회로 송신 간극과 수신 안테나 조정' },
  },
  {
    id: 'EMERGENCY_MEDICINE', name: '응급 의학', era: 'MODERN_LATE', tier: 36, cost: 176, prereqs: ['BACTERIOLOGICAL_LAB', 'HUMANITARIAN_LOGISTICS'], tags: ['SPIRITUAL', 'SURVIVAL'], branch: 'FAITH',
    description: '분류·지혈·이송 순서를 체계화해 위기 상황의 부상과 사망 위험을 줄입니다.',
    unlocks: { passives: ['MODERN_MEDICAL_TECH_STACK'] },
    eureka: { type: 'haveItem', itemId: 'herb_tonic', count: 10, bonusPct: 0.25, desc: '약초 달임 10개를 응급 처치 꾸러미로 분산 배치' },
  },
  {
    id: 'AUTOMOBILE', name: '자동차', era: 'MODERN_LATE', tier: 37, cost: 182, prereqs: ['INTERNAL_COMBUSTION_ENGINE', 'ELECTRIC_GRID'], tags: ['CRAFT', 'SCIENCE'], branch: 'ENGINEERING',
    description: '내연 기관·조향·제동을 하나의 차체에 통합해 운송과 자원 이동의 생산성을 높입니다.',
    unlocks: { passives: ['MODERN_ENGINEERING_TECH_STACK'] },
    eureka: { type: 'actionSuccess', action: 'craft', count: 66, bonusPct: 0.25, desc: '제작 성공 66회로 차축·조향·제동 장치 통합' },
  },
  {
    id: 'ATOMIC_THEORY', name: '원자 이론', era: 'MODERN_LATE', tier: 37, cost: 182, prereqs: ['PERIODIC_LAW', 'X_RAY_IMAGING'], tags: ['SCIENCE'], branch: 'NATURAL_PHILOSOPHY',
    description: '물질을 원자와 하위 입자의 구조로 설명해 화학·전기·방사선 연구를 하나로 연결합니다.',
    unlocks: { passives: ['MODERN_SCIENCE_TECH_STACK'] },
    eureka: { type: 'surviveDays', count: 46, bonusPct: 0.25, desc: '46일 동안 원소 질량과 방전 실험 자료 축적' },
  },
  {
    id: 'COLD_CHAIN', name: '냉장 유통', era: 'MODERN_LATE', tier: 37, cost: 182, prereqs: ['REFRIGERATION', 'ARTIFICIAL_FERTILIZER'], tags: ['SURVIVAL', 'CRAFT'], branch: 'SURVIVAL',
    description: '생산지부터 저장고까지 저온을 유지해 식량·의약품 손실과 장기 생존 압력을 줄입니다.',
    unlocks: { passives: ['MODERN_SURVIVAL_TECH_STACK'] },
    eureka: { type: 'actionSuccess', action: 'gather', count: 54, bonusPct: 0.25, desc: '채집 성공 54회의 운송 거리별 부패율 비교' },
  },
  {
    id: 'POWERED_FLIGHT', name: '동력 비행', era: 'MODERN_LATE', tier: 38, cost: 188, prereqs: ['AUTOMOBILE', 'TURBINE_WARSHIP'], tags: ['MILITARY', 'SCIENCE'], branch: 'MILITARY',
    description: '양력·조종·경량 동력을 결합해 지형을 넘어 정찰하고 위험에 먼저 대응합니다.',
    unlocks: { passives: ['MODERN_MILITARY_TECH_STACK'] },
    eureka: { type: 'actionSuccess', action: 'hunt', count: 40, bonusPct: 0.25, desc: '사냥 성공 40회로 바람·균형·추적 동선 기록' },
  },
  {
    id: 'MOTION_PICTURES', name: '영화', era: 'MODERN_LATE', tier: 38, cost: 188, prereqs: ['PHONOGRAPH', 'PHOTOGRAPHY'], tags: ['CULTURE', 'CRAFT'], branch: 'LITERATURE',
    description: '연속 사진과 투사를 결합해 사건·공연·지식을 움직이는 기록으로 보존합니다.',
    unlocks: { passives: ['MODERN_MEDIA_TECH_STACK'] },
    eureka: { type: 'actionSuccess', action: 'craft', count: 68, bonusPct: 0.25, desc: '제작 성공 68회로 촬영·현상·투사 속도 동기화' },
  },
  {
    id: 'BLOOD_TYPING', name: '혈액형', era: 'MODERN_LATE', tier: 38, cost: 188, prereqs: ['X_RAY_IMAGING', 'EMERGENCY_MEDICINE'], tags: ['SPIRITUAL', 'SCIENCE'], branch: 'FAITH',
    description: '혈액의 응집 반응을 분류해 안전한 수혈과 중상자 치료의 성공률을 높입니다.',
    unlocks: { passives: ['MODERN_MEDICAL_TECH_STACK'] },
    eureka: { type: 'haveItem', itemId: 'herb_tonic', count: 11, bonusPct: 0.25, desc: '약초 달임 11개와 치료 환자의 혈액 반응 기록 대조' },
  },
  {
    id: 'CORPORATE_ENTERPRISE', name: '주식 회사', era: 'MODERN_LATE', tier: 27, cost: 138, prereqs: ['FACTORY_SYSTEM', 'ELECTRIC_GENERATION'], tags: ['CIVICS', 'CRAFT'], branch: 'ENGINEERING',
    description: '자본과 책임을 지분으로 나누어 대규모 생산·전력·운송 사업을 지속적으로 운영합니다.',
    unlocks: { passives: ['MODERN_ENGINEERING_CIVIC_STACK'] },
    inspiration: { type: 'campLevel', key: 'workbenchLevel', count: 3, bonusPct: 0.25, desc: '작업대 Lv.3에서 공동 지분과 생산 장부 운영' },
  },
  {
    id: 'RESEARCH_UNIVERSITY', name: '연구 대학', era: 'MODERN_LATE', tier: 27, cost: 138, prereqs: ['PROFESSIONAL_SCIENCE', 'PERIODIC_LAW'], tags: ['CIVICS', 'SCIENCE'], branch: 'NATURAL_PHILOSOPHY',
    description: '교육과 실험을 한 기관에 결합해 전문 연구자와 장기 연구 계획을 양성합니다.',
    unlocks: { passives: ['MODERN_SCIENCE_CIVIC_STACK'] },
    inspiration: { type: 'campLevel', key: 'libraryShelfLevel', count: 1, bonusPct: 0.25, desc: '서가에서 공개 강의와 실험 보고회 운영' },
  },
  {
    id: 'SOCIAL_INSURANCE', name: '사회 보험', era: 'MODERN_LATE', tier: 27, cost: 138, prereqs: ['LABOR_PROTECTION', 'ANTISEPTIC_SURGERY'], tags: ['CIVICS', 'SURVIVAL'], branch: 'SURVIVAL',
    description: '질병·부상·노령 위험을 공동 기금으로 분담해 생존 압력과 회복 격차를 줄입니다.',
    unlocks: { passives: ['MODERN_SURVIVAL_CIVIC_STACK'] },
    inspiration: { type: 'actionFail', action: 'craft', count: 12, bonusPct: 0.25, desc: '제작 실패 12회의 부상·휴업 비용 공동 조사' },
  },
  {
    id: 'NATIONAL_MOBILIZATION', name: '국민 동원', era: 'MODERN_LATE', tier: 28, cost: 144, prereqs: ['NATION_STATE', 'MACHINE_GUN'], tags: ['CIVICS', 'MILITARY'], branch: 'MILITARY',
    description: '인력·수송·물자를 전국 단위 계획으로 묶어 파티 정원과 위기 대응력을 높입니다.',
    unlocks: { passives: ['MODERN_MILITARY_CIVIC_STACK'] },
    inspiration: { type: 'actionSuccess', action: 'hunt', count: 34, bonusPct: 0.25, desc: '사냥 성공 34회의 인력·식량·장비 동원표 작성' },
  },
  {
    id: 'MASS_JOURNALISM', name: '대중 언론', era: 'MODERN_LATE', tier: 28, cost: 144, prereqs: ['LIBERALISM', 'TELEPHONE'], tags: ['CIVICS', 'CULTURE'], branch: 'LITERATURE',
    description: '통신망과 대량 인쇄를 결합해 공동체의 사건·논쟁·지식을 빠르게 공유합니다.',
    unlocks: { passives: ['MODERN_MEDIA_CIVIC_STACK'] },
    inspiration: { type: 'campFireDays', count: 36, bonusPct: 0.25, desc: '공개 취재와 공동체 소식 토론 36회' },
  },
  {
    id: 'SOCIAL_GOSPEL', name: '사회 복음', era: 'MODERN_LATE', tier: 28, cost: 144, prereqs: ['HUMANITARIANISM', 'DISTRICT_NURSING'], tags: ['SPIRITUAL', 'CIVICS'], branch: 'FAITH',
    description: '신앙의 실천을 빈곤·질병·노동 환경 개선과 연결해 공동체 회복을 강화합니다.',
    unlocks: { passives: ['MODERN_FAITH_CIVIC_STACK'] },
    inspiration: { type: 'haveItem', itemId: 'herb_tonic', count: 8, bonusPct: 0.25, desc: '약초 달임 8개를 지역 무료 진료에 제공' },
  },
  {
    id: 'STANDARD_TIME', name: '표준시', era: 'MODERN_LATE', tier: 29, cost: 150, prereqs: ['CORPORATE_ENTERPRISE', 'ELECTRIC_GRID'], tags: ['CIVICS', 'CRAFT'], branch: 'ENGINEERING',
    description: '지역마다 다른 시간을 하나의 기준으로 맞춰 운송·생산·통신 계획의 손실을 줄입니다.',
    unlocks: { passives: ['MODERN_ENGINEERING_CIVIC_STACK'] },
    inspiration: { type: 'surviveDays', count: 42, bonusPct: 0.25, desc: '42일 동안 이동·작업·통신 시각표 비교' },
  },
  {
    id: 'STATISTICAL_ADMINISTRATION', name: '통계 행정', era: 'MODERN_LATE', tier: 29, cost: 150, prereqs: ['RESEARCH_UNIVERSITY', 'PERIODIC_LAW'], tags: ['CIVICS', 'SCIENCE'], branch: 'NATURAL_PHILOSOPHY',
    description: '인구·생산·질병 자료를 동일한 기준으로 집계해 정책과 연구의 예측력을 높입니다.',
    unlocks: { passives: ['MODERN_SCIENCE_CIVIC_STACK'] },
    inspiration: { type: 'weatherTypes', count: 5, bonusPct: 0.25, desc: '다섯 날씨의 생산·질병·이동 통계를 같은 표로 정리' },
  },
  {
    id: 'MUNICIPAL_WELFARE', name: '도시 복지', era: 'MODERN_LATE', tier: 29, cost: 150, prereqs: ['SOCIAL_INSURANCE', 'PASTEURIZATION'], tags: ['CIVICS', 'SURVIVAL'], branch: 'SURVIVAL',
    description: '급식·방역·주거·진료를 도시 행정에 묶어 취약한 부족원의 생존 기반을 지킵니다.',
    unlocks: { passives: ['MODERN_SURVIVAL_CIVIC_STACK'] },
    inspiration: { type: 'campLevel', key: 'shelterLevel', count: 3, bonusPct: 0.25, desc: '대피소 Lv.3에서 급식·방역·진료 구역 운영' },
  },
  {
    id: 'INTERNATIONAL_LAW', name: '국제법', era: 'MODERN_LATE', tier: 30, cost: 156, prereqs: ['NATIONAL_MOBILIZATION', 'TURBINE_WARSHIP'], tags: ['CIVICS', 'MILITARY'], branch: 'MILITARY',
    description: '국가 간 분쟁·포로·항행 규칙을 문서화해 무력 충돌의 피해와 불확실성을 줄입니다.',
    unlocks: { passives: ['MODERN_MILITARY_CIVIC_STACK'] },
    inspiration: { type: 'actionSuccess', action: 'hunt', count: 38, bonusPct: 0.25, desc: '사냥 성공 38회의 공동 경계·포획·분배 규칙 합의' },
  },
  {
    id: 'COMPULSORY_EDUCATION', name: '의무 교육', era: 'MODERN_LATE', tier: 30, cost: 156, prereqs: ['MASS_JOURNALISM', 'PUBLIC_EDUCATION'], tags: ['CIVICS', 'CULTURE'], branch: 'LITERATURE',
    description: '모든 구성원에게 공통 문해·수리·시민 교육을 제공해 연구와 기록의 저변을 넓힙니다.',
    unlocks: { passives: ['MODERN_MEDIA_CIVIC_STACK'] },
    inspiration: { type: 'haveItem', itemId: 'book_craft_guide', count: 1, bonusPct: 0.25, desc: '제작 안내서로 공통 수업 과정과 출석부 편찬' },
  },
  {
    id: 'ECUMENICAL_MOVEMENT', name: '교회 일치 운동', era: 'MODERN_LATE', tier: 30, cost: 156, prereqs: ['SOCIAL_GOSPEL', 'BACTERIOLOGICAL_LAB'], tags: ['SPIRITUAL', 'CIVICS'], branch: 'FAITH',
    description: '서로 다른 교파가 구호·교육·평화의 공동 목표를 위해 협력하도록 합니다.',
    unlocks: { passives: ['MODERN_FAITH_CIVIC_STACK'] },
    inspiration: { type: 'surviveDays', count: 46, bonusPct: 0.25, desc: '46일 동안 교파 공동 구호와 교육 운영' },
  },
  {
    id: 'REGULATED_UTILITIES', name: '공익 사업 규제', era: 'MODERN_LATE', tier: 31, cost: 162, prereqs: ['STANDARD_TIME', 'ELECTRIC_GRID'], tags: ['CIVICS', 'CRAFT'], branch: 'ENGINEERING',
    description: '전력·교통·통신의 가격과 품질 기준을 정해 기반 시설을 안정적으로 운영합니다.',
    unlocks: { passives: ['MODERN_ENGINEERING_CIVIC_STACK'] },
    inspiration: { type: 'campLevel', key: 'workbenchLevel', count: 3, bonusPct: 0.25, desc: '작업대 Lv.3에서 전력·운송 유지비와 공급 기준 공개' },
  },
  {
    id: 'PROFESSIONAL_LICENSING', name: '전문 자격제', era: 'MODERN_LATE', tier: 31, cost: 162, prereqs: ['STATISTICAL_ADMINISTRATION', 'X_RAY_IMAGING'], tags: ['CIVICS', 'SCIENCE'], branch: 'NATURAL_PHILOSOPHY',
    description: '의료·과학·공학 업무의 교육과 검증 기준을 세워 전문 지식의 신뢰성을 높입니다.',
    unlocks: { passives: ['MODERN_SCIENCE_CIVIC_STACK'] },
    inspiration: { type: 'campLevel', key: 'libraryShelfLevel', count: 1, bonusPct: 0.25, desc: '서가에서 실기 시험과 전문 기록 심사 운영' },
  },
  {
    id: 'TRADE_UNIONISM', name: '노동조합', era: 'MODERN_LATE', tier: 31, cost: 162, prereqs: ['MUNICIPAL_WELFARE', 'FACTORY_SYSTEM'], tags: ['CIVICS', 'SURVIVAL'], branch: 'SURVIVAL',
    description: '노동자가 임금·시간·안전을 공동 협상해 생산과 생존의 균형을 맞춥니다.',
    unlocks: { passives: ['MODERN_SURVIVAL_CIVIC_STACK'] },
    inspiration: { type: 'actionFail', action: 'craft', count: 14, bonusPct: 0.25, desc: '제작 실패 14회의 사고와 과로 원인 공동 조사' },
  },
  {
    id: 'HAGUE_CONVENTIONS', name: '헤이그 협약', era: 'MODERN_LATE', tier: 32, cost: 168, prereqs: ['INTERNATIONAL_LAW', 'EMERGENCY_MEDICINE'], tags: ['CIVICS', 'MILITARY'], branch: 'MILITARY',
    description: '전쟁 수단과 포로·부상자 보호의 공통 규범을 세워 위기 대응의 인도적 한계를 정합니다.',
    unlocks: { passives: ['MODERN_MILITARY_CIVIC_STACK'] },
    inspiration: { type: 'actionSuccess', action: 'hunt', count: 42, bonusPct: 0.25, desc: '사냥 성공 42회의 비전투원·부상자 보호 규칙 확립' },
  },
  {
    id: 'UNIVERSAL_SUFFRAGE', name: '보통 선거', era: 'MODERN_LATE', tier: 32, cost: 168, prereqs: ['COMPULSORY_EDUCATION', 'MASS_JOURNALISM'], tags: ['CIVICS', 'CULTURE'], branch: 'LITERATURE',
    description: '재산과 신분의 제한을 줄이고 더 많은 구성원이 대표와 정책 결정에 참여하게 합니다.',
    unlocks: { passives: ['MODERN_MEDIA_CIVIC_STACK'] },
    inspiration: { type: 'campFireDays', count: 42, bonusPct: 0.25, desc: '후보 토론·공개 투표·결과 공표 42회' },
  },
  {
    id: 'RELIGIOUS_PLURALISM', name: '종교 다원주의', era: 'MODERN_LATE', tier: 32, cost: 168, prereqs: ['ECUMENICAL_MOVEMENT', 'SOCIAL_GOSPEL'], tags: ['SPIRITUAL', 'CIVICS'], branch: 'FAITH',
    description: '서로 다른 신앙과 비신앙의 동등한 시민권을 인정해 갈등을 줄이고 공동체 회복을 높입니다.',
    unlocks: { passives: ['MODERN_FAITH_CIVIC_STACK'] },
    inspiration: { type: 'haveItem', itemId: 'herb_tonic', count: 10, bonusPct: 0.25, desc: '약초 달임 10개를 신앙 구분 없이 공동 배급' },
  },
];
...
export const DIFFICULTY_PRESETS = {
  ...
  normal: {
    ...
    desc: '기본 생존 밸런스입니다.',
    ruleSummary: '보정 없이 문명 아카이브 기본 흐름으로 시작합니다.',
    apMax: 4,
    hungerMultiplier: 1,
    coldMultiplier: 1,
