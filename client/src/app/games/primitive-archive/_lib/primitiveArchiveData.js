...
export const TECH_TREE = [
  ...
  { id: 'FIREMAKING', name: '불 피우기', era: 'PRIMITIVE', cost: 12, prereqs: ['GATHERING'], unlocks: { passives: ['COOKING_RECOVERY_UP'], camp: ['fire'], recipes: ['jerky'] }, eureka: { type: 'campAction', kind: 'cook', count: 1, bonusPct: 0.3, desc: '구운 고기 제작 1회' } },
  { id: 'STONE_TOOLS', name: '석기 도구', era: 'PRIMITIVE', cost: 12, prereqs: ['GATHERING'], unlocks: { passives: ['CRAFT_SUCCESS_UP'], recipes: ['stone_axe', 'flint_knife', 'bone_pick', 'charm', 'crafter_amulet', 'gatherer_charm'] }, eureka: { type: 'recipeCraft', recipeId: 'stone_axe', count: 1, bonusPct: 0.25, desc: '도구 제작 1회' } },
  ...
  { id: 'HERBALISM', name: '약초 지식', era: 'PRIMITIVE', cost: 12, prereqs: ['GATHERING'], unlocks: { passives: ['REST_HEAL_UP'], recipes: ['herb_tonic'] }, eureka: { type: 'haveItem', itemId: 'herb', count: 3, bonusPct: 0.3, desc: '약초 3개 보유' } },
  ...
  { id: 'TRAPPING', name: '덫 사냥', era: 'NEOLITHIC', cost: 16, prereqs: ['HUNTING', 'CORDAGE'], unlocks: { passives: ['HUNT_RISK_DOWN'], recipes: ['leather_strip', 'sling', 'hide_coat', 'hide_pants', 'shoes_leather', 'hat_fur', 'earmuffs', 'socks', 'gloves', 'arm_warmers', 'leggings', 'pauldron', 'hunter_talisman'] }, eureka: { type: 'actionFail', action: 'hunt', count: 1, bonusPct: 0.15, desc: '사냥 실패 1회' } },
  { id: 'ARCHERY', name: '궁술', era: 'NEOLITHIC', cost: 18, prereqs: ['HUNTING', 'CORDAGE'], unlocks: { recipes: ['bow', 'atlatl'], passives: ['BOW_HUNT_UP'] }, eureka: { type: 'recipeCraft', recipeId: 'bow', count: 1, bonusPct: 0.3, desc: '활 제작 1회' } },
  { id: 'SETTLEMENT', name: '정착', era: 'NEOLITHIC', cost: 20, prereqs: ['SHELTER'], unlocks: { passives: ['CAMP_SCORE_UP', 'PARTY_CAP_UP'], recipes: ['spear', 'fur_coat', 'fur_pants', 'fur_hat', 'fur_boots', 'fur_earmuffs', 'fur_socks', 'fur_gloves'] }, eureka: { type: 'campLevel', key: 'shelterLevel', count: 2, bonusPct: 0.25, desc: '대피소 Lv.2 달성' } },
  ...
  { id: 'FOOD_STORAGE', name: '식량 저장', era: 'ANCIENT', cost: 30, prereqs: ['FIREMAKING', 'SETTLEMENT'], unlocks: { recipes: ['packed_ration'], passives: ['STORAGE_RATIONS_UP'] }, eureka: { type: 'haveItem', itemId: 'jerky', count: 2, bonusPct: 0.25, desc: '육포 2개 보유' } },
  { id: 'ADVANCED_CARVING', name: '정밀 세공', era: 'ANCIENT', cost: 30, prereqs: ['STONE_TOOLS', 'TRAPPING'], unlocks: { recipes: ['bone_awl'], passives: ['ADVANCED_CRAFT_UP'] }, eureka: { type: 'recipeCraft', recipeId: 'flint_knife', count: 1, bonusPct: 0.25, desc: '부싯돌 칼 제작 1회' } },
  { id: 'OBSIDIAN_KNAPPING', name: '흑요석 떼기', era: 'ANCIENT', cost: 34, prereqs: ['ADVANCED_CARVING', 'ARCHERY'], unlocks: { recipes: ['obsidian_blade'], passives: ['OBSIDIAN_HUNT_UP'] }, eureka: { type: 'haveItem', itemId: 'obsidian_shard', count: 2, bonusPct: 0.25, desc: '흑요석 조각 2개 보유' } },
  { id: 'MEGAFAUNA_HIDE', name: '대형 가죽 가공', era: 'ANCIENT', cost: 36, prereqs: ['SETTLEMENT', 'TRAPPING'], unlocks: { recipes: ['dino_scale_vest'], passives: ['MEGAFAUNA_RISK_DOWN'] }, eureka: { type: 'haveItem', itemId: 'dino_hide', count: 2, bonusPct: 0.25, desc: '공룡 가죽 2개 보유' } },
  { id: 'CLAY_TABLETS', name: '점토 기록판', era: 'ANCIENT', cost: 36, prereqs: ['LIBRARY'], unlocks: { recipes: ['clay_tablet'], passives: ['TABLET_RESEARCH_UP'] }, eureka: { type: 'haveItem', itemId: 'clay', count: 6, bonusPct: 0.25, desc: '점토 6개 보유' } },
  { id: 'WEATHER_LORE', name: '날씨 해석', era: 'ANCIENT', cost: 34, prereqs: ['ORAL_RECORDS', 'LIBRARY'], unlocks: { recipes: ['weather_totem'], passives: ['WEATHER_LORE_UP'] }, eureka: { type: 'weatherTypes', count: 4, bonusPct: 0.25, desc: '서로 다른 날씨 4종 관찰' } },
];
