...
export const TECH_TREE = [
  {
    id: 'GATHERING', name: '채집', era: 'PRIMITIVE', cost: 10, prereqs: [], tags: ['SURVIVAL'], archiveRequired: true,
  ...
  {
    id: 'HUNTING', name: '수렵', era: 'PRIMITIVE', cost: 10, prereqs: [], tags: ['SURVIVAL', 'MILITARY'], archiveRequired: true,
  ...
  {
    id: 'FIREMAKING', name: '불 피우기', era: 'PRIMITIVE', cost: 12, prereqs: ['GATHERING'], tags: ['CAMP', 'SURVIVAL'], archiveRequired: true,
  ...
  {
    id: 'STONE_TOOLS', name: '석기 도구', era: 'PRIMITIVE', cost: 12, prereqs: ['GATHERING'], tags: ['CRAFT'], archiveRequired: true,
  ...
  {
    id: 'CORDAGE', name: '끈과 밧줄', era: 'PRIMITIVE', cost: 12, prereqs: ['GATHERING'], tags: ['CRAFT'], archiveRequired: true,
  ...
  {
    id: 'HERBALISM', name: '약초 지식', era: 'PRIMITIVE', cost: 12, prereqs: ['GATHERING'], tags: ['SURVIVAL'], archiveRequired: true,
  ...
  {
    id: 'SHELTER', name: '집 짓기', era: 'PRIMITIVE', cost: 14, prereqs: ['FIREMAKING'], tags: ['CAMP'], archiveRequired: true,
  ...
  {
    id: 'FISHING', name: '어로', era: 'NEOLITHIC', cost: 16, prereqs: ['HUNTING', 'CORDAGE'], tags: ['SURVIVAL'], archiveRequired: true,
  ...
  {
    id: 'POTTERY', name: '토기', era: 'NEOLITHIC', cost: 16, prereqs: ['FIREMAKING'], tags: ['CRAFT', 'CAMP'],
  ...
  {
    id: 'CRAFTSMANSHIP', name: '장인 정신', era: 'NEOLITHIC', cost: 18, prereqs: ['STONE_TOOLS', 'CORDAGE'], tags: ['CRAFT'], archiveRequired: true,
  ...
  {
    id: 'HEARTH', name: '화덕', era: 'NEOLITHIC', cost: 18, prereqs: ['FIREMAKING', 'POTTERY'], tags: ['CAMP', 'SURVIVAL'],
  ...
  {
    id: 'ORAL_RECORDS', name: '구전 기록', era: 'NEOLITHIC', cost: 18, prereqs: ['HERBALISM', 'SHELTER'], tags: ['CULTURE', 'SCIENCE'], archiveRequired: true,
  ...
  {
    id: 'TRAPPING', name: '덫 사냥', era: 'NEOLITHIC', cost: 16, prereqs: ['HUNTING', 'CORDAGE'], tags: ['SURVIVAL', 'MILITARY'],
  ...
  {
    id: 'ARCHERY', name: '궁술', era: 'NEOLITHIC', cost: 20, prereqs: ['CRAFTSMANSHIP', 'HUNTING'], tags: ['MILITARY', 'CRAFT'],
  ...
  {
    id: 'SETTLEMENT', name: '정착', era: 'NEOLITHIC', cost: 20, prereqs: ['SHELTER'], tags: ['CAMP', 'CIVICS'], archiveRequired: true,
  ...
  {
    id: 'AGRICULTURE', name: '농업', era: 'NEOLITHIC', cost: 20, prereqs: ['GATHERING', 'SETTLEMENT'], tags: ['SURVIVAL', 'CIVICS'], archiveRequired: true,
  ...
  {
    id: 'ANIMAL_HUSBANDRY', name: '목축', era: 'NEOLITHIC', cost: 20, prereqs: ['HUNTING', 'SETTLEMENT'], tags: ['SURVIVAL', 'CIVICS'], archiveRequired: true,
  ...
  {
    id: 'COUNTING', name: '셈법', era: 'NEOLITHIC', cost: 18, prereqs: ['SETTLEMENT', 'ORAL_RECORDS'], tags: ['SCIENCE', 'CIVICS'],
  ...
  {
    id: 'CALENDAR', name: '달력', era: 'NEOLITHIC', cost: 18, prereqs: ['COUNTING', 'ORAL_RECORDS'], tags: ['SCIENCE'],
  ...
  {
    id: 'CARTOGRAPHY', name: '지도 제작', era: 'NEOLITHIC', cost: 18, prereqs: ['ORAL_RECORDS', 'GATHERING'], tags: ['SCIENCE', 'SURVIVAL'], archiveRequired: true,
  ...
  {
    id: 'ARCHIVE', name: '기록 보관', era: 'NEOLITHIC', cost: 22, prereqs: ['SETTLEMENT', 'ORAL_RECORDS'], tags: ['CULTURE', 'CIVICS'], archiveRequired: true,
  ...
  {
    id: 'WRITING', name: '문자', era: 'ANCIENT', cost: 24, prereqs: ['ARCHIVE', 'COUNTING'], tags: ['SCIENCE', 'CULTURE'], archiveRequired: true,
  ...
  {
    id: 'MINING', name: '채광', era: 'ANCIENT', cost: 26, prereqs: ['STONE_TOOLS', 'SETTLEMENT'], tags: ['CRAFT', 'SCIENCE'],
  ...
  {
    id: 'BRONZE_WORKING', name: '초기 청동 기술', era: 'ANCIENT', cost: 32, prereqs: ['MINING', 'FIREMAKING'], tags: ['CRAFT', 'MILITARY'],
  ...
  {
    id: 'BASIC_SAILING', name: '기초 항해', era: 'ANCIENT', cost: 28, prereqs: ['FISHING', 'CARTOGRAPHY'], tags: ['SCIENCE', 'SURVIVAL'],
  ...
  {
    id: 'BOOKCRAFT', name: '책 제작', era: 'ANCIENT', cost: 24, prereqs: ['WRITING', 'CORDAGE'], tags: ['CRAFT', 'CULTURE'], archiveRequired: true,
  ...
  {
    id: 'LIBRARY', name: '서가 정리', era: 'ANCIENT', cost: 26, prereqs: ['BOOKCRAFT'], tags: ['SCIENCE', 'CULTURE'], archiveRequired: true,
  ...
  {
    id: 'FOOD_STORAGE', name: '식량 저장', era: 'ANCIENT', cost: 28, prereqs: ['HEARTH', 'SETTLEMENT'], tags: ['SURVIVAL', 'CAMP'],
  ...
  {
    id: 'ADVANCED_CARVING', name: '정밀 세공', era: 'ANCIENT', cost: 28, prereqs: ['STONE_TOOLS', 'CRAFTSMANSHIP', 'TRAPPING'], tags: ['CRAFT'],
  ...
  {
    id: 'OBSIDIAN_KNAPPING', name: '흑요석 떼기', era: 'ANCIENT', cost: 32, prereqs: ['ADVANCED_CARVING', 'ARCHERY'], tags: ['CRAFT', 'MILITARY'],
  ...
  {
    id: 'MEGAFAUNA_HIDE', name: '대형 가죽 가공', era: 'ANCIENT', cost: 34, prereqs: ['SETTLEMENT', 'TRAPPING', 'ARCHERY'], tags: ['CRAFT', 'SURVIVAL'],
  ...
  {
    id: 'CLAY_TABLETS', name: '점토 기록판', era: 'ANCIENT', cost: 32, prereqs: ['LIBRARY', 'POTTERY'], tags: ['SCIENCE', 'CULTURE'],
  ...
  {
    id: 'MYSTICISM', name: '신비주의', era: 'ANCIENT', cost: 24, prereqs: ['HEARTH', 'SETTLEMENT'], tags: ['SPIRITUAL', 'CULTURE'],
  ...
  {
    id: 'ASTROLOGY', name: '점성술', era: 'ANCIENT', cost: 28, prereqs: ['CALENDAR', 'MYSTICISM'], tags: ['SCIENCE', 'SPIRITUAL'],
  ...
  {
    id: 'MILITARY_TRADITION', name: '군사 전통', era: 'ANCIENT', cost: 26, prereqs: ['HUNTING', 'SETTLEMENT'], tags: ['MILITARY', 'CIVICS'],
  ...
  {
    id: 'STATE_WORKFORCE', name: '국가 노동력', era: 'ANCIENT', cost: 30, prereqs: ['SETTLEMENT', 'WRITING'], tags: ['CIVICS'],
  ...
  {
    id: 'EARLY_THEOLOGY', name: '초기 신학', era: 'ANCIENT', cost: 30, prereqs: ['MYSTICISM', 'WRITING'], tags: ['SPIRITUAL', 'CULTURE'],
  ...
  {
    id: 'FOREIGN_TRADE', name: '외국 무역', era: 'ANCIENT', cost: 30, prereqs: ['CARTOGRAPHY', 'STATE_WORKFORCE'], tags: ['CIVICS', 'SURVIVAL'],
  ...
  {
    id: 'HISTORY_RECORDS', name: '역사 기록', era: 'ANCIENT', cost: 28, prereqs: ['WRITING', 'ARCHIVE'], tags: ['CULTURE', 'CIVICS'],
  ...
  {
    id: 'BASIC_MATH', name: '기초 수학', era: 'ANCIENT', cost: 28, prereqs: ['COUNTING', 'WRITING'], tags: ['SCIENCE'],
  ...
  {
    id: 'BASIC_PHILOSOPHY', name: '기초 철학', era: 'ANCIENT', cost: 28, prereqs: ['WRITING', 'MYSTICISM'], tags: ['CULTURE', 'SCIENCE'],
  ...
  {
    id: 'EARLY_CONSTRUCTION', name: '초기 건설', era: 'ANCIENT', cost: 28, prereqs: ['CRAFTSMANSHIP', 'SETTLEMENT'], tags: ['CAMP', 'CIVICS'],
  ...
  {
    id: 'EARLY_CIVIL_ENGINEERING', name: '초기 토목', era: 'ANCIENT', cost: 30, prereqs: ['EARLY_CONSTRUCTION', 'CARTOGRAPHY'], tags: ['CAMP', 'SCIENCE'],
  ...
  {
    id: 'IRRIGATION', name: '관개', era: 'ANCIENT', cost: 32, prereqs: ['AGRICULTURE', 'EARLY_CIVIL_ENGINEERING'], tags: ['SURVIVAL', 'SCIENCE'],
  ...
  {
    id: 'GLASSMAKING', name: '유리 제작', era: 'ANCIENT', cost: 30, prereqs: ['POTTERY', 'ADVANCED_CARVING'], tags: ['CRAFT', 'SCIENCE'],
  ...
  {
    id: 'FORTIFICATION', name: '방벽과 방어시설', era: 'ANCIENT', cost: 30, prereqs: ['EARLY_CONSTRUCTION', 'MILITARY_TRADITION'], tags: ['MILITARY', 'CAMP'],
  ...
  {
    id: 'ASTRONOMY_EARLY', name: '초기 천문', era: 'CLASSICAL', cost: 38, prereqs: ['ASTROLOGY', 'BASIC_MATH'], tags: ['SCIENCE'],
  ...
  {
    id: 'CLASSICAL_PHILOSOPHY', name: '고전 철학', era: 'CLASSICAL', cost: 40, prereqs: ['BASIC_PHILOSOPHY', 'BASIC_MATH'], tags: ['CULTURE', 'SCIENCE'],
  ...
  {
    id: 'DRAMA', name: '드라마', era: 'CLASSICAL', cost: 40, prereqs: ['CLASSICAL_PHILOSOPHY', 'HISTORY_RECORDS'], tags: ['CULTURE'],
  ...
  {
    id: 'POETRY', name: '시', era: 'CLASSICAL', cost: 42, prereqs: ['DRAMA', 'WRITING'], tags: ['CULTURE', 'SPIRITUAL'],
  ...
  {
    id: 'EARLY_ART', name: '초기 미술', era: 'CLASSICAL', cost: 40, prereqs: ['CLASSICAL_PHILOSOPHY', 'CLAY_TABLETS'], tags: ['CULTURE', 'CRAFT'],
  ...
  {
    id: 'EARLY_MUSIC', name: '초기 음악', era: 'CLASSICAL', cost: 42, prereqs: ['POETRY', 'EARLY_THEOLOGY'], tags: ['CULTURE', 'SPIRITUAL'],
  ...
  {
    id: 'EARLY_HORSEBACK', name: '초기 기마술', era: 'CLASSICAL', cost: 42, prereqs: ['ANIMAL_HUSBANDRY', 'MILITARY_TRAINING'], tags: ['MILITARY', 'CIVICS'],
  ...
  {
    id: 'EARLY_IRONWORKING', name: '초기 철제 기술', era: 'CLASSICAL', cost: 44, prereqs: ['BRONZE_WORKING', 'OBSIDIAN_KNAPPING'], tags: ['CRAFT', 'MILITARY'],
  ...
  {
    id: 'BASIC_SHIPBUILDING', name: '기초 조선', era: 'CLASSICAL', cost: 42, prereqs: ['BASIC_SAILING', 'EARLY_CONSTRUCTION'], tags: ['CRAFT', 'SCIENCE'],
  ...
  {
    id: 'EARLY_CURRENCY', name: '초기 화폐', era: 'CLASSICAL', cost: 42, prereqs: ['FOREIGN_TRADE', 'COUNTING'], tags: ['CIVICS', 'SCIENCE'],
  ...
  {
    id: 'EARLY_OPTICS', name: '초기 광학', era: 'CLASSICAL', cost: 40, prereqs: ['ASTRONOMY_EARLY', 'GLASSMAKING'], tags: ['SCIENCE', 'CRAFT'],
  ...
  {
    id: 'MILITARY_TRAINING', name: '군사 훈련', era: 'CLASSICAL', cost: 40, prereqs: ['MILITARY_TRADITION', 'STATE_WORKFORCE'], tags: ['MILITARY'],
  ...
  {
    id: 'DEFENSE_TACTICS', name: '방어술', era: 'CLASSICAL', cost: 40, prereqs: ['FORTIFICATION'], tags: ['MILITARY', 'SURVIVAL'],
  ...
  {
    id: 'EARLY_EMPIRE', name: '초기 제국', era: 'CLASSICAL', cost: 44, prereqs: ['STATE_WORKFORCE', 'FOREIGN_TRADE', 'EARLY_CURRENCY'], tags: ['CIVICS'],
