...
export const TECH_TREE = [
  ...
  {
    id: 'CLASSICAL_PHILOSOPHY', name: '고전 철학', era: 'CLASSICAL', tier: 5, cost: 40, prereqs: ['BASIC_PHILOSOPHY', 'BASIC_MATH'], tags: ['CULTURE', 'SCIENCE'],
  ...
  {
    id: 'DRAMA', name: '드라마', era: 'CLASSICAL', tier: 6, cost: 42, prereqs: ['CLASSICAL_PHILOSOPHY', 'HISTORY_RECORDS'], tags: ['CULTURE'],
  ...
  {
    id: 'POETRY', name: '시', era: 'CLASSICAL', tier: 7, cost: 44, prereqs: ['DRAMA'], tags: ['CULTURE', 'SPIRITUAL'],
  ...
  {
    id: 'EARLY_MUSIC', name: '초기 음악', era: 'CLASSICAL', tier: 8, cost: 48, prereqs: ['POETRY', 'EARLY_THEOLOGY'], tags: ['CULTURE', 'SPIRITUAL'],
  ...
  {
    id: 'EARLY_CURRENCY', name: '초기 화폐', era: 'CLASSICAL', tier: 10, cost: 42, prereqs: ['BASIC_MATH'], tags: ['CIVICS', 'SCIENCE'],
  ...
  {
    id: 'EARLY_EMPIRE', name: '초기 제국', era: 'CLASSICAL', tier: 8, cost: 48, prereqs: ['FOREIGN_TRADE', 'EARLY_CURRENCY'], tags: ['CIVICS'],
  ...
  {
    id: 'THREE_FIELD_SYSTEM', name: '삼포농법', era: 'MEDIEVAL', tier: 11, cost: 46, prereqs: ['IRRIGATION', 'EARLY_EMPIRE'], tags: ['SURVIVAL', 'SCIENCE'], branch: 'SURVIVAL',
  ...
  {
    id: 'BLOOMERY_FURNACE', name: '괴철로', era: 'MEDIEVAL', tier: 11, cost: 46, prereqs: ['EARLY_IRONWORKING'], tags: ['CRAFT', 'SCIENCE'], branch: 'ENGINEERING',
  ...
  {
    id: 'LATEEN_SAIL', name: '삼각돛', era: 'MEDIEVAL', tier: 11, cost: 46, prereqs: ['BASIC_SHIPBUILDING'], tags: ['CRAFT', 'SCIENCE'], branch: 'ENGINEERING',
    description: '역풍에서도 방향을 유지하는 돛으로 강가 탐사의 수익을 높입니다.',
    unlocks: { passives: ['LATEEN_RIVER_UP'] },
    eureka: { type: 'weatherTypes', count: 5, bonusPct: 0.25, desc: '서로 다른 날씨 5종 관찰' },
  },
  {
    id: 'HERBAL_MEDICINE', name: '약초 의학', era: 'MEDIEVAL', tier: 11, cost: 46, prereqs: ['HERBALISM', 'EARLY_THEOLOGY'], tags: ['SURVIVAL', 'SCIENCE'], branch: 'SURVIVAL',
  ...
  {
    id: 'FEUDAL_CONTRACT', name: '봉건 계약', era: 'MEDIEVAL', tier: 9, cost: 52, prereqs: ['EARLY_EMPIRE', 'MILITARY_TRAINING'], tags: ['CIVICS', 'MILITARY'], branch: 'MILITARY',
  ...
  {
    id: 'EPIC_TRADITION', name: '서사 전승', era: 'MEDIEVAL', tier: 9, cost: 52, prereqs: ['POETRY', 'HISTORY_RECORDS'], tags: ['CULTURE'], branch: 'LITERATURE',
  ...
  {
    id: 'WATERMILL', name: '수차', era: 'MEDIEVAL', tier: 12, cost: 50, prereqs: ['EARLY_CIVIL_ENGINEERING', 'BASIC_MATH'], tags: ['CRAFT', 'SCIENCE'], branch: 'ENGINEERING',
  ...
  {
    id: 'SCHOLASTICISM', name: '스콜라 철학', era: 'MEDIEVAL', tier: 10, cost: 56, prereqs: ['MONASTIC_RULE', 'CLASSICAL_PHILOSOPHY'], tags: ['SPIRITUAL', 'SCIENCE'], branch: 'NATURAL_PHILOSOPHY',
