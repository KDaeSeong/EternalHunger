...
const ACTION_RULES = {
  ...
  '계절 대비': { key: 'seasonPlan', action: 'primitive-season-plan', counter: 'season_plan', cue: 'archiveSeasonPlan', successLabel: '계절 대비 완료', failureLabel: '계절 대비 불가' },
  '훈련 태세': { key: 'drill', action: 'primitive-drill', counter: 'drill', cue: 'archiveDrill', successLabel: '훈련 태세 준비', failureLabel: '훈련 태세 불가' },
  '학술 토론': { key: 'debate', action: 'primitive-debate', counter: 'debate', cue: 'archiveDebate', successLabel: '학술 토론 완료', failureLabel: '학술 토론 불가' },
  ...
  '가마 굽기': { key: 'kiln', action: 'primitive-kiln', counter: 'kiln', cue: 'archiveKiln', successLabel: '가마 굽기 완료', failureLabel: '가마 굽기 불가' },
  '방직': { key: 'weave', action: 'primitive-weave', counter: 'weave', cue: 'archiveWeave', successLabel: '방직 완료', failureLabel: '방직 불가' },
  '제련': { key: 'smelt', action: 'primitive-smelt', counter: 'smelt', cue: 'archiveSmelt', successLabel: '제련 완료', failureLabel: '제련 불가' },
  '단조': { key: 'forge', action: 'primitive-forge', counter: 'forge', cue: 'archiveForge', successLabel: '단조 완료', failureLabel: '단조 불가' },
  '제분': { key: 'mill', action: 'primitive-mill', counter: 'mill', cue: 'archiveMill', successLabel: '제분 완료', failureLabel: '제분 불가' },
  '시장 거래': { key: 'market', action: 'primitive-market', counter: 'market', cue: 'archiveMarket', successLabel: '시장 거래 완료', failureLabel: '시장 거래 불가' },
...
const ACTION_RESULT_PATTERNS = {
  ...
  '치료': /치료 완료|치료:/,
  '축제': /축제 운영|축제:/,
  '계절 대비': /계절 대비 완료|계절 대비 계획 적용/,
  '훈련 태세': /훈련 태세 완료|훈련 태세를 적용/,
  '학술 토론': /학술 토론 완료|학술 토론.*(?:RP|CP)/,
  '관개 정비': /관개 정비|관개 효과/,
  '가마 굽기': /가마 굽기 완료|토기.*생산/,
  '방직': /방직 완료|직물.*생산/,
  '제련': /제련 완료|금속 주괴.*생산/,
  '단조': /단조 완료|금속 공구.*생산/,
  '제분': /제분 완료|제분 곡물.*생산/,
  '시장 거래': /시장 거래 완료|내주고.*확보/,
