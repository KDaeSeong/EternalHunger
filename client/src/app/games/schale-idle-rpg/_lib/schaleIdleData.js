...
export const ENHANCE_RULES = [
  {
    ...
    baseCredit: 80,
    creditGrowth: 1.18,
    requiresPerTry: { itm_enhance_stone: 1, itm_battery: 1 },
    scrapPerLevel: 6,
    successBase: 0.9,
    successDecay: 0.02,
  ...
  },
  {
    ...
    baseCredit: 75,
    creditGrowth: 1.18,
    requiresPerTry: { itm_enhance_stone: 1, itm_bandage: 2 },
    scrapPerLevel: 6,
    successBase: 0.9,
    successDecay: 0.02,
    failPenalty: 'DOWNGRADE_1',
  ...
  },
  {
    ...
    baseCredit: 95,
    creditGrowth: 1.18,
    requiresPerTry: { itm_enhance_stone: 1, itm_memory_chip: 1 },
    scrapPerLevel: 8,
    successBase: 0.88,
    successDecay: 0.025,
    failPenalty: 'NONE',
  ...
  {
    itemId: 'eq_spare_battery_pack',
    maxLevel: 10,
    baseCredit: 85,
    creditGrowth: 1.18,
    requiresPerTry: { itm_enhance_stone: 1, itm_battery: 2 },
    scrapPerLevel: 7,
    successBase: 0.9,
    successDecay: 0.02,
    failPenalty: 'DOWNGRADE_1',
  ...
  },
  {
    ...
    baseCredit: 150,
    creditGrowth: 1.2,
    requiresPerTry: { itm_enhance_stone: 2, itm_memory_chip: 1, itm_battery: 2 },
    scrapPerLevel: 10,
    successBase: 0.8,
    successDecay: 0.03,
    failPenalty: 'DESTROY',
  ...
  {
    itemId: 'eq_tower_relic_beta',
    maxLevel: 10,
    baseCredit: 160,
    creditGrowth: 1.2,
    requiresPerTry: { itm_enhance_stone: 2, itm_memory_chip: 1, itm_battery: 1 },
    scrapPerLevel: 10,
    successBase: 0.82,
    successDecay: 0.028,
    failPenalty: 'DOWNGRADE_1',
  ...
  {
    itemId: 'eq_tower_relic_omega',
    maxLevel: 10,
    baseCredit: 190,
    creditGrowth: 1.2,
    requiresPerTry: { itm_enhance_stone: 2, itm_memory_chip: 2, itm_battery: 1 },
    scrapPerLevel: 12,
    successBase: 0.8,
    successDecay: 0.03,
    failPenalty: 'DOWNGRADE_1',
