...
const DEFAULT_ITEM_TREE = [
  ...
  // --- 소모품 샘플(최소) ---
  {
    key: 'fresh_apple',
    name: '신선한 사과',
    // ⚠️ ItemSchema.type enum에는 'food'가 없으므로, 소모품 + tags로 구분합니다.
    type: '소모품',
    tier: 1,
    rarity: 'common',
    stackMax: 6,
  ...
  },
  {
    ...
    baseCreditValue: 30,
    tags: ['food'],
    description: '기본 음식. (가벼운 회복)\n※ 관전형 시뮬에서는 자동으로 사용될 수 있습니다.',
  },
  {
    key: 'chocolate',
    name: '초콜릿',
  ...
  // --- 사냥/요리 루프용 재료/음식 ---
  {
    ...
    baseCreditValue: 20,
    tags: ['meat', 'raw'],
    description: '야생동물에게서 얻는 재료. 모닥불에서 스테이크로 구울 수 있다.',
  },
  {
    key: 'steak',
    name: '스테이크',
    ...
    stackMax: 6,
    baseCreditValue: 70,
    tags: ['food', 'cooked', 'healthy'],
    description: '모닥불에서 구운 스테이크. (회복 강화)',
    recipeKeys: [{ key: 'meat_raw', qty: 1 }],
  },
  {
    key: 'chicken_food',
    name: '치킨',
    ...
    baseCreditValue: 80,
    tags: ['food', 'cooked'],
    description: '변이 닭에게서 얻는 음식. (회복 강화)',
  },
  {
    key: 'bandage',
    name: '붕대',
