...
- Historical naming and lore: 60 advancement display names now use compact Civilization-style noun phrases while preserving stable save IDs and prerequisite relationships. Every one of the 160 technology/civic nodes carries a topic-matched public-domain quotation with author, work, and source URL; both locked previews and live research inspectors show the quotation and open its source in a new tab.
