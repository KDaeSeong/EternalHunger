...
- UI/UX: match replay now stores broadcast headlines, turning points, tighter Starleague-style caster/analyst timelines, replay-center breakdowns, bench reactions, and a series replay report that summarizes the scoreline, key set, build tendency, map spread, and replay highlights across regular league, personal league, and Winners League sets.
