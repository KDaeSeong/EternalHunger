...
- Included loop: party selection, zone selection, gather, hunt, craft, eat, rest, camp upgrades, day rollover, death/end state, primitive/neolithic/ancient/classical tech-tree research, separate eureka and inspiration triggers, turn/day automatic RP, research passives, run settlement, perk points, perk shop, and perk-applied new runs.
...
- Next step: tune late-run survival numbers and event-chain reward/risk weights after several full runs.
