...
- Next step: tune late-run survival numbers after playtesting the ancient pressure weighting, then add more event chains around rare resources and megafauna hunts.
