...
- Next step: continue replacing the simplified match/economy model with more selected original `simulateSet` details, richer league shop/trade balancing, postseason presentation, and historical rivalry tracking.
...
- Next step: connect property/town artwork affordances behind the site save/record shell, then deepen skill effects beyond the current damage/heal/shield/status action model.
