...
- Next step: deepen skill effects beyond the current damage/heal/shield/status action model, then add richer mission-map events and property upgrade branches.
