...
- Next step: continue replacing the simplified match model with more selected original `simulateSet` details, then tune front-office recommendation weights after playtesting several full seasons.
