...
- Next step: tune late-run survival numbers after playtesting the ancient pressure weighting, then add more event chains and recovery choices around rare resources and megafauna hunts.
...
- Next step: continue replacing the simplified match/economy model with more selected original `simulateSet` details, richer league shop/trade balancing, and deeper postseason presentation.
