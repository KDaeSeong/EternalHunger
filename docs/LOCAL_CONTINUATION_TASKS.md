...
- Primitive Archive research now has 60 connected Primitive/Neolithic/Ancient/Classical nodes arranged into explicit T1-T12 stages. Every prerequisite points to a lower tier, automatic target selection favors the lowest available tier, and the record branch now progresses Writing -> Clay Tablets/Bookcraft -> Library. Campfire + shelter + workbench Lv.1 unlock target selection and turn/day automatic RP; completing T1 Gathering + Hunting unlocks the manual research action.
