...
2. In progress: `client/src/app/games/schale-idle-rpg/play/page.js`
   ...
   - Next: split `SchaleIdleFeatureTabs.js` into tab-group components (`plan`, `season`, `sync`, `duty`, `gear`, `records`).
