...
- Primitive Archive's research map shows sticky tier headers with stage names and node counts, includes tier labels in nodes/dropdowns/recommendations, and keeps only the map canvas horizontally scrollable on narrow screens.
